...
Return ONLY valid JSON array.`,
    variants: [
      ...
      },
      {
        ...
        region: "US",
        defaultCount: 25,
        domainWeights: { "Patient Assessment": [0.20, 0.25], "Mechanical Ventilation": [0.25, 0.35], "ABG & Acid-Base": [0.15, 0.20], "Cardiopulmonary Pathophysiology": [0.15, 0.20], "Equipment & Safety": [0.10, 0.15] },
      ...
      },
      {
        ...
        region: "US",
        defaultCount: 25,
        domainWeights: { "Ethics & Law": [0.25, 0.30], "Assessment & Intervention": [0.30, 0.40], "Social Policy & Advocacy": [0.15, 0.25], "Diversity & Cultural Practice": [0.15, 0.20] },
        requiredTypeMix: { MCQ_SINGLE: 10, CASE_BASED_CLUSTER: 10, PRIORITIZATION: 5 },

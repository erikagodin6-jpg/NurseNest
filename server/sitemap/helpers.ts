...
export function getSharedStaticRoutes(today: string): StaticRouteDefinition[] {
  const multilingualRoutes: Omit<StaticRouteDefinition, "multilingual">[] = [
    ...
    { path: "/philippines-to-canada", priority: "0.7", changefreq: "monthly", lastmod: today },
    { path: "/india-to-canada", priority: "0.7", changefreq: "monthly", lastmod: today },
    { path: "/philippines-to-usa", priority: "0.7", changefreq: "monthly", lastmod: today },
    { path: "/india-to-uk", priority: "0.7", changefreq: "monthly", lastmod: today },
    { path: "/philippines-to-uk", priority: "0.7", changefreq: "monthly", lastmod: today },
    { path: "/india-to-australia", priority: "0.7", changefreq: "monthly", lastmod: today },
    { path: "/nigeria-to-canada", priority: "0.7", changefreq: "monthly", lastmod: today },
    { path: "/nepal-to-uk", priority: "0.7", changefreq: "monthly", lastmod: today },

...
export const alliedAuthoredTopics = [...alliedTopics01,...alliedTopics02,...alliedTopics03,...alliedTopics04,...alliedTopics05,...alliedTopics06,...alliedTopics07,...alliedTopics08];
...
export const ALLIED_AUTHORED_TARGETS = Object.freeze({ minimumTopics:164, lessonsPerTopic:5, minimumLessons:820, questionsPerTopic:100, minimumQuestions:16_400 });

...
export const alliedAuthoredTopics = [...alliedTopics01,...alliedTopics02,...alliedTopics03,...alliedTopics04,...alliedTopics05,...alliedTopics06,...alliedTopics07,...alliedTopics08,...alliedTopics09,...diagnosticSonographyTopics10,...diagnosticSonographyAbdominalTopics11,...diagnosticSonographyObGynTopics12];
...
export const ALLIED_AUTHORED_TARGETS = Object.freeze({ minimumTopics:210, lessonsPerTopic:5, minimumLessons:1_050, questionsPerTopic:100, minimumQuestions:21_000 });

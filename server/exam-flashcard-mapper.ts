...
const IMAGE_KEYWORD_MAP: Record<string, { file: string; alt: string; caption: string; description: string }[]> = {
  ...
  "infant of diabetic mother": [{ file: "newbornofdiabeticmother", alt: "Newborn of diabetic mother illustration", caption: "Infant of Diabetic Mother", description: "Complications and management of infants born to diabetic mothers" }],
  "newborn of diabetic mother": [{ file: "newbornofdiabeticmother", alt: "Newborn of diabetic mother illustration", caption: "Newborn of Diabetic Mother", description: "Complications and management of newborns of diabetic mothers" }],
  "osteogenesis imperfecta": [{ file: "osteogenesisimperfecta", alt: "Osteogenesis imperfecta illustration", caption: "Osteogenesis Imperfecta", description: "Brittle bone disease: types, signs, and management" }],
  ...
  "intestinal malrotation": [{ file: "intestinalmalrotation", alt: "Intestinal malrotation illustration", caption: "Intestinal Malrotation", description: "Congenital abnormal bowel rotation with volvulus risk" }],

...
const IMAGE_KEYWORD_MAP: Record<string, { file: string; alt: string; caption: string; description: string }[]> = {
  ...
  "pressure injury": [{ file: "pressureinjuries_1773375118294", alt: "Pressure injuries illustration", caption: "Pressure Injuries", description: "Staging, prevention, and management of pressure ulcers" }],
  "pressure ulcer": [{ file: "pressureinjuries_1773375118294", alt: "Pressure injuries illustration", caption: "Pressure Injuries", description: "Pressure injury prevention: repositioning, nutrition, skin assessment" }],
  "decubitus": [{ file: "pressureinjuries_1773375118294", alt: "Pressure injuries illustration", caption: "Pressure Injuries", description: "Pressure ulcer staging from Stage 1 to unstageable" }],

      ...
      <section id="included" className="py-16 bg-gradient-to-b from-white to-primary/5 border-t border-gray-100" data-testid="section-included">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-4xl mx-auto">
            {[
              { icon: Target, title: t("home.included.qbank.title"), desc: t("home.included.qbank.desc"), href: "/preview/med-surg", count: formatCount(questionCount), countLabel: t("home.included.countQuestions"), color: "from-blue-500 to-indigo-600" },

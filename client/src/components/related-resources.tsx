...
export const STUDY_CROSS_LINKS: Record<string, RelatedResource[]> = {
  lessons: [
    ...
    { title: "Test Bank", href: "/test-bank", description: "Test your knowledge with practice questions organized by body system.", icon: "qbank" },
  ...
  flashcards: [
    ...
    { title: "Test Bank", href: "/test-bank", description: "Apply flashcard knowledge to practice questions.", icon: "qbank" },
  ...
  mockExams: [
    { title: "Test Bank", href: "/test-bank", description: "Practice more questions organized by body system and difficulty.", icon: "qbank" },
  ...
  simulators: [
    ...
    { title: "Test Bank", href: "/test-bank", description: "Practice NCLEX-style questions after simulations.", icon: "qbank" },
  ...
  blog: [
    ...
    { title: "Test Bank", href: "/test-bank", description: "Test your understanding with NCLEX-style practice questions.", icon: "qbank" },
  ...
  examGuide: [
    ...
    { title: "Test Bank", href: "/test-bank", description: "Study with thousands of practice questions by topic.", icon: "qbank" },
  ...
  professionHub: [
    ...
    { title: "Practice Questions", href: "/test-bank", description: "Thousands of practice questions organized by exam domain.", icon: "qbank" },
...
const TOPIC_RESOURCE_MAP: Record<string, RelatedResource[]> = {
  ...
  "exam-prep": [
    ...
    { title: "Test Bank", href: "/test-bank", description: "Practice with thousands of NCLEX-style questions.", icon: "qbank" },

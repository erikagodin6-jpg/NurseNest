...
export default function ResumePage() {
  ...
  return (
    <div data-testid="newgrad-resume-page">
      <Navigation />
      <SEO
        title="New Grad Nurse Resume Builder, Cover Letters & Personal Statements | NurseNest"
        description={`Build a standout nursing resume with ATS-optimized templates, ${totalBullets}+ resume bullet examples, ${totalCoverLetters} cover letter templates, and ${totalStatements} personal statement prompts. Designed for new graduate nurses.`}
        ...
        breadcrumbs={[
          ...
          { name: "Resume & Documents", url: "https://www.nursenest.ca/newgrad/resume" },
        ]}
      />
      ...
      <section className="relative py-16 sm:py-20 overflow-hidden" data-testid="section-hero">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-pink-700 font-medium">Resume & Documents</span>
          </div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium mb-4 bg-pink-100 text-pink-700">
            <FileText className="w-4 h-4" /> Resume, Cover Letters & Personal Statements
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4" data-testid="text-title">
            Career Document Toolkit
          </h1>
          <p className="text-lg text-gray-600 mb-6">
            Everything you need to apply with confidence: ATS-optimized resume templates, a copy-paste bullet bank, cover letter examples for every specialty, and personal statement prompts for scholarships and graduate programs.
          </p>
      ...
      <section className="py-12 bg-gradient-to-r from-pink-50 to-rose-50" data-testid="section-bottom-cta">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-3">Complete Your Career Readiness Toolkit</h2>
          <p className="text-sm text-gray-500 mb-4">
            Pair your resume with interview prep and workplace readiness scenarios for a complete job-search strategy.
          </p>

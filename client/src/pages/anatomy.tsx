      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white" data-testid="section-internal-links">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <LocaleLink href="/test-bank" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white border border-gray-200 hover:border-primary/30 hover:shadow-sm transition-all text-sm font-medium text-gray-600 hover:text-primary" data-testid="link-list-test-bank">

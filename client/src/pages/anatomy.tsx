...
const bodySystems = [
  {
    id: "cell-structure",
    nameKey: "anatomy.sys.cellStructure",
    descriptionKey: "anatomy.sys.cellStructureDesc",
    icon: Microscope,
  ...
  {
    id: "feedback-loops",
    nameKey: "anatomy.sys.feedbackLoops",
    descriptionKey: "anatomy.sys.feedbackLoopsDesc",
    icon: RefreshCw,
  ...
  {
    id: "cardiovascular",
    nameKey: "anatomy.sys.cardiovascular",
    descriptionKey: "anatomy.sys.cardiovascularDesc",
    icon: Heart,
    color: "text-red-500",
  ...
  {
    id: "respiratory",
    nameKey: "anatomy.sys.respiratory",
    descriptionKey: "anatomy.sys.respiratoryDesc",
    icon: Wind,
    color: "text-sky-500",
  ...
  {
    id: "nervous",
    nameKey: "anatomy.sys.nervous",
    descriptionKey: "anatomy.sys.nervousDesc",
    icon: Brain,
  ...
  {
    id: "musculoskeletal",
    nameKey: "anatomy.sys.musculoskeletal",
    descriptionKey: "anatomy.sys.musculoskeletalDesc",
    icon: Bone,
  ...
  {
    id: "gastrointestinal",
    nameKey: "anatomy.sys.gastrointestinal",
    descriptionKey: "anatomy.sys.gastrointestinalDesc",
  ...
  {
    id: "renal",
    nameKey: "anatomy.sys.renal",
    descriptionKey: "anatomy.sys.renalDesc",
    icon: Droplets,
    color: "text-blue-500",
  ...
  {
    id: "endocrine",
    nameKey: "anatomy.sys.endocrine",
    descriptionKey: "anatomy.sys.endocrineDesc",
    icon: Zap,
  ...
  {
    id: "integumentary",
    nameKey: "anatomy.sys.integumentary",
    descriptionKey: "anatomy.sys.integumentaryDesc",
    icon: Shield,
  ...
  {
    id: "lymphatic-immune",
    nameKey: "anatomy.sys.lymphaticImmune",
    descriptionKey: "anatomy.sys.lymphaticImmuneDesc",
    icon: ShieldCheck,
    color: "text-teal-500",
  ...
  {
    id: "reproductive",
    nameKey: "anatomy.sys.reproductive",
    descriptionKey: "anatomy.sys.reproductiveDesc",
    icon: Baby,
    color: "text-pink-500",

    ...
    return (
      <div data-testid="page-regulatory-not-found">
        ...
        <div className="max-w-3xl mx-auto px-4 py-24 text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Regulatory Body Not Found</h1>
          <p className="text-gray-600 mb-6">The regulatory body page you're looking for doesn't exist.</p>
    ...
    <div data-testid={`page-regulatory-${body.slug}`}>
      ...
      <section className="relative py-16 sm:py-20 overflow-hidden" data-testid="section-hero">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <Link href="/nursing-regulatory-bodies" className="hover:text-purple-600">Regulatory Bodies</Link>
            <ChevronRight className="w-3.5 h-3.5" />
      ...
      <section className="py-12 bg-white border-b border-gray-100" data-testid="section-authority">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-xl font-bold text-gray-900 mb-3">Licensing Authority</h2>
      ...
      <section className="py-16 bg-gray-50" data-testid="section-exams">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Exam Requirements</h2>
          ...
          <div className="mt-6 p-5 bg-blue-50 rounded-xl border border-blue-100">
            <h3 className="font-semibold text-blue-900 mb-2 text-sm">Prepare with NurseNest</h3>
            <p className="text-sm text-blue-700 mb-3">NurseNest offers comprehensive exam prep for NCLEX-RN, REX-PN, and NP certification exams with adaptive practice questions and clinical simulations.</p>
      ...
      <section className="py-16" data-testid="section-credential-recognition">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Credential Recognition</h2>
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href="/exam-prep" className="group" data-testid="link-exam-prep">
              <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md hover:border-blue-200 transition-all h-full">
                ...
                <p className="text-xs text-gray-500">Adaptive practice for NCLEX, REX-PN, and certification exams.</p>
              </div>
            </Link>
            <Link href="/nursing-schools" className="group" data-testid="link-schools">
              <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md hover:border-emerald-200 transition-all h-full">
                ...
                <p className="text-xs text-gray-500">Find accredited nursing programs worldwide.</p>
              </div>
            </Link>
            <Link href="/applynest" className="group" data-testid="link-applynest">
              <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md hover:border-teal-200 transition-all h-full">
                ...
                <p className="text-xs text-gray-500">Resume templates and job search for nurses.</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section className="py-12 bg-white" data-testid="section-other-bodies">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4 text-center">Explore Other Regulatory Bodies</h2>

...
const EXAM_DATA: Record<ExamType, {
  ...
  "nclex-rn": {
    ...
    features: [
      { icon: Target, title: "NCLEX-RN Test Bank", desc: "Thousands of RN-level practice questions organized by body system and client needs category.", href: "/practice-questions", cta: "Browse Questions" },
  ...
  "nclex-pn": {
    ...
    features: [
      { icon: Target, title: "NCLEX-PN Test Bank", desc: "Practice questions at the PN scope covering fundamentals, med-surg, pharmacology, and maternal-child.", href: "/practice-questions", cta: "Browse Questions" },
  ...
  "rex-pn": {
    ...
    features: [
      { icon: Target, title: "REx-PN Test Bank", desc: "Canadian-focused practice questions with SI units, Canadian drug names, and provincial scope references.", href: "/practice-questions", cta: "Browse Questions" },
  ...
  "np": {
    ...
    features: [
      { icon: Target, title: "NP Test Bank", desc: "Advanced practice-level questions covering diagnosis, management, and prescribing at the NP scope.", href: "/practice-questions", cta: "Browse Questions" },

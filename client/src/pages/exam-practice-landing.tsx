...
const EXAM_DATA: Record<ExamType, {
  ...
  "rex-pn": {
    ...
    faqs: [
      ...
      { q: "Does NurseNest use Canadian lab values?", a: "Yes. NurseNest is built for Canadian nursing students. All lab values use SI units (mmol/L for electrolytes, umol/L for creatinine, degrees Celsius for temperature). Medication names follow Canadian conventions." },

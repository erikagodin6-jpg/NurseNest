...
const comparisonData: Record<string, ComparisonData> = {
  "nursenest-vs-uworld": {
    ...
    pricingNote: "NurseNest Pro costs 93% less than UWorld while offering more study tools including flashcards, clinical simulations, and Canadian exam support.",
    faqs: [
  ...
  "nursenest-vs-archer": {
    ...
    pricingNote: "NurseNest Pro costs 75% less than Archer on a monthly basis with more learning tools including flashcards, clinical simulations, and Canadian exam content.",
    faqs: [
      ...
      { question: "What study tools does NurseNest have that Archer doesn't?", answer: "NurseNest includes AI-generated flashcards, spaced repetition, clinical case simulations, medication mastery tools, video micro-lectures, a safety hazard simulator, and Canadian REx-PN content — none of which are available on Archer." },
    ],
    hubLinks: [
      { label: "Browse NCLEX Lessons", href: "/lessons" },
      { label: "Try Free Practice Questions", href: "/question-of-the-day" },
  ...
  "best-uworld-alternatives-nclex": {
    ...
    features: [
      ...
      { feature: "Medication Mastery Tool", nurseNest: true, competitor: false },
      { feature: "Safety Hazard Simulator", nurseNest: true, competitor: false },
      { feature: "Canada REx-PN Content", nurseNest: true, competitor: false },
      { feature: "French Language Support", nurseNest: true, competitor: false },

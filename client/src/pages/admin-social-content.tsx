    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900" data-testid="heading-social-content">Social Content Automation</h1>
            <p className="text-sm text-gray-500 mt-1">Auto-generated social media content from lessons and blog posts</p>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3 mb-4">
          ...
          >
            ...
            <option value="quiz_question">Quiz Questions</option>
            <option value="clinical_pearl">Clinical Pearls</option>
            <option value="infographic_spec">Infographics</option>
          </select>
          <select
            value={filterStatus}
          ...
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-400 text-sm">No social content generated yet.</p>
                <p className="text-gray-400 text-xs mt-1">Click "Generate Now" to create content from your lessons and blog posts.</p>
              </div>
            ) : (
              <>

...
export default function GeneratorV2Page() {
  ...
  const openPublishDialog = () => {
    ...
    const rpnSeoKeywords = "REx-PN practice questions Canada, REx-PN question bank, REx-PN mock exam, REx-PN practice test, REx-PN review questions, REx-PN exam prep Canada, CPNRE practice questions, RPN exam practice questions Canada, RPN question bank Canada, best REx-PN question bank, free REx-PN practice questions, REx-PN sample questions, how to pass REx-PN first attempt, REx-PN study guide Canada, practical nursing exam prep, LPN exam practice questions, Canadian RPN exam practice questions";
    const npSeoKeywords = "NP exam practice questions Canada, nurse practitioner exam prep, NP clinical questions, OSCE NP prep Canada, NP certification practice questions, nurse practitioner question bank, NP exam review Canada";
    const tierKeywords = examTgt.includes("rn") ? rnSeoKeywords : examTgt.includes("np") ? npSeoKeywords : rpnSeoKeywords;

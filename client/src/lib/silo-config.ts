...
export const SILO_CONFIGS: Record<string, SiloConfig> = {
  "nclex-rn": {
    ...
    internalLinks: [
      { label: "NCLEX-RN Question Bank", href: "/question-bank" },
  ...
  "nclex-pn": {
    ...
    internalLinks: [
      { label: "NCLEX-PN Question Bank", href: "/question-bank" },
      { label: "Timed Mock Exams", href: "/mock-exams" },
      { label: "Question of the Day", href: "/question-of-the-day" },
      { label: "Clinical Lessons", href: "/lessons" },
      { label: "Flashcard Study Decks", href: "/flashcards" },
  ...
  "rex-pn": {
    ...
    internalLinks: [
      { label: "REx-PN Question Bank", href: "/question-bank" },
      { label: "Timed Mock Exams", href: "/mock-exams" },
      { label: "Question of the Day", href: "/question-of-the-day" },
      { label: "Clinical Lessons", href: "/lessons" },
      { label: "Flashcard Study Decks", href: "/flashcards" },
  ...
  "np": {
    ...
    internalLinks: [
      { label: "NP Question Bank", href: "/question-bank" },
      { label: "Timed Mock Exams", href: "/mock-exams" },
      { label: "Question of the Day", href: "/question-of-the-day" },

...
export const EXAM_BLUEPRINTS: Record<string, ExamBlueprint> = {
  ...
  "AGACNP": {
    ...
    scaledScoreRange: { min: 100, max: 500, passScore: 350 },
    domains: [
      { name: "Health Assessment", weight: 0.20 },
      { name: "Diagnosis", weight: 0.25 },
      { name: "Therapeutics", weight: 0.30 },
      { name: "Health Promotion & Disease Prevention", weight: 0.10 },
      { name: "Professional Role & Responsibility", weight: 0.15 },
    ],
  ...
  "PMHNP": {
    ...
    scaledScoreRange: { min: 100, max: 500, passScore: 350 },
    domains: [
      { name: "Psychiatric Assessment & Diagnosis", weight: 0.25 },
      { name: "Psychopharmacology", weight: 0.30 },
      { name: "Therapeutic Modalities", weight: 0.20 },
      { name: "Crisis Intervention & Safety", weight: 0.10 },
      { name: "Professional Role & Ethics", weight: 0.15 },
    ],
    difficultyMix: { high: 0.25, moderate: 0.55, foundational: 0.20 },
  },
  "PNP": {
    ...
    scaledScoreRange: { min: 100, max: 500, passScore: 350 },
    domains: [
      { name: "Growth, Development & Aging", weight: 0.20 },
      { name: "Pediatric Assessment & Diagnosis", weight: 0.25 },
      { name: "Pediatric Therapeutics & Pharmacology", weight: 0.25 },
      { name: "Health Promotion & Disease Prevention", weight: 0.15 },
      { name: "Professional Role & Responsibility", weight: 0.15 },
    ],
    difficultyMix: { high: 0.20, moderate: 0.60, foundational: 0.20 },
  ...
  "WHNP": {
    ...
    scaledScoreRange: { min: 100, max: 500, passScore: 350 },
    domains: [
      { name: "Reproductive Health", weight: 0.25 },
      { name: "Obstetric Care", weight: 0.20 },
      { name: "Gynecologic Care", weight: 0.20 },
  ...
  "ENP": {
    ...
    scaledScoreRange: { min: 200, max: 800, passScore: 500 },
    domains: [
      { name: "Trauma & Resuscitation", weight: 0.25 },
      { name: "Medical Emergencies", weight: 0.25 },
      { name: "Procedural Skills & Diagnostics", weight: 0.20 },
      { name: "Pharmacology & Pain Management", weight: 0.15 },
      { name: "Professional Role & Disposition", weight: 0.15 },
    ],
    difficultyMix: { high: 0.30, moderate: 0.50, foundational: 0.20 },
  },
  "RDCS-AE": {

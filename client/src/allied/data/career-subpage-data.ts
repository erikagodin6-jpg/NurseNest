...
export const CAREER_SUBPAGE_DATA: Record<string, CareerSubpageData> = {
  ...
  "physiotherapy-assistant": {
    studyTopics: [
      { title: "Therapeutic Exercise Prescription", slug: "therapeutic-exercise", description: "ROM exercises, strengthening programs, endurance training, flexibility protocols, and exercise progression principles", icon: "Activity" },
      { title: "Physical Agents & Modalities", slug: "physical-modalities", description: "Therapeutic ultrasound, electrical stimulation (TENS, NMES, IFC), hot/cold packs, iontophoresis, and phonophoresis", icon: "Zap" },
      ...
      { title: "Musculoskeletal Special Tests", slug: "musculoskeletal-tests", description: "Orthopedic special tests for shoulder, knee, hip, spine, and ankle — including sensitivity and specificity", icon: "Search" },
      { title: "Neurological Rehabilitation", slug: "neuro-rehab", description: "Stroke rehabilitation, spinal cord injury, TBI, Parkinson's, MS, PNF patterns, and neurodevelopmental treatment (NDT)", icon: "Brain" },
      { title: "Cardiopulmonary Rehabilitation", slug: "cardiopulmonary-rehab", description: "Cardiac rehab protocols, pulmonary rehab, vital sign monitoring, Borg scale, MET levels, and exercise tolerance testing", icon: "Heart" },
      { title: "Wound Care & Integumentary", slug: "wound-care", description: "Wound assessment, debridement types, wound dressings, pressure injury staging, and healing phases", icon: "Shield" },
      { title: "Data Collection & Measurement", slug: "data-collection", description: "Goniometry, manual muscle testing (MMT), pain scales, functional outcome measures, and vital signs assessment", icon: "BarChart" },
      { title: "Patient Education & Home Programs", slug: "patient-education", description: "Teaching principles, home exercise programs, self-management strategies, and patient compliance techniques", icon: "GraduationCap" },
      { title: "Safety, Transfers & Body Mechanics", slug: "safety-transfers", description: "Transfer techniques, body mechanics, fall prevention, wheelchair management, and infection control", icon: "ShieldCheck" },
    ],
    flashcardDecks: [
    ...
    examModes: [
      ...
      { title: "System-Focused Practice", slug: "pta-system-practice", description: "Target specific body systems (musculoskeletal, neuro, cardiopulmonary) with focused question sets", questionCount: 50, timeMinutes: 60, icon: "Target" },
      { title: "Quick Practice Quiz", slug: "pta-quick-quiz", description: "15-question mini quiz for daily practice with immediate feedback and scoring", questionCount: 15, timeMinutes: 20, icon: "Zap" },
    ],
    careerGuide: {

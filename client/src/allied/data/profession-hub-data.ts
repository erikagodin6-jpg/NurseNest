...
export const PROFESSION_HUB_DATA: Record<string, ProfessionHubData> = {
  ...
  "cardiac-sonographer": {
    ...
    examInfo: {
      examNames: ["ARDMS RDCS (AE)", "ARDMS RDCS (PE)", "CCI RCS"],
      examDescription: "The ARDMS offers the RDCS credential with Adult Echocardiography (AE) and Pediatric Echocardiography (PE) specialties. CCI offers the Registered Cardiac Sonographer (RCS) as an alternative credential. Both require passing specialty exams demonstrating competency in cardiac anatomy, hemodynamics, pathology, and imaging techniques.",
      examFormat: "The RDCS-AE exam consists of 170 questions with a 3-hour time limit covering cardiac anatomy/physiology, hemodynamics, valvular disease, cardiomyopathies, and echocardiographic techniques. The CCI RCS exam has a similar structure testing cardiac imaging competency.",
      certifyingBodies: ["ARDMS (American Registry for Diagnostic Medical Sonography)", "CCI (Cardiovascular Credentialing International)", "Sonography Canada"],
    },

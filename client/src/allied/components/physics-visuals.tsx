  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="kvp-visualizer">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="font-bold text-gray-900">kVp Visualizer</h3>
      </div>
      <p className="text-sm text-gray-600">Adjust kVp to see how it affects beam penetration, contrast, and scatter.</p>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-blue-50 rounded-xl p-3 text-center">
          <div className="text-xs text-blue-600 mb-1">Penetration</div>
        ...
        <div className="bg-purple-50 rounded-xl p-3 text-center">
          <div className="text-xs text-purple-600 mb-1">Contrast</div>
        ...
        <div className="bg-red-50 rounded-xl p-3 text-center">
          <div className="text-xs text-red-600 mb-1">Scatter</div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 text-sm text-amber-800">
        <strong>Key Concept:</strong> Higher kVp = more penetration, lower contrast, more scatter radiation. Lower kVp = less penetration, higher contrast, less scatter.
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="mas-simulator">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="font-bold text-gray-900">mAs Change Simulator</h3>
      </div>
      <p className="text-sm text-gray-600">Adjust mA and time to see the effect on mAs and image density.</p>
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="text-xs text-gray-500 block mb-1">Tube Current (mA)</label>
        ...
        <div>
          <label className="text-xs text-gray-500 block mb-1">Exposure Time (s)</label>
      ...
      <div className="bg-teal-50 rounded-xl p-4 text-center">
        <div className="text-sm text-teal-600">mAs = mA × time</div>
        <div className="text-3xl font-bold text-teal-700 mt-1" data-testid="text-mas-value">{mas.toFixed(1)} mAs</div>
      </div>
      <div className="bg-gray-100 rounded-xl p-4">
        <div className="text-xs text-gray-500 mb-2">Image Density</div>
      ...
      <div className="bg-teal-50 border border-teal-200 rounded-xl p-3 text-sm text-teal-800">
        <strong>Key Concept:</strong> mAs controls quantity of x-rays (density). Doubling mAs doubles the number of x-ray photons. To change density visibly, change mAs by at least 30%.
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="inverse-square-law">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="font-bold text-gray-900">Inverse Square Law</h3>
      </div>
      <p className="text-sm text-gray-600">See how radiation intensity decreases with distance from the source.</p>
      <div className="flex items-center gap-4">
      ...
      <div className="relative bg-indigo-50 rounded-xl p-4 h-40">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 flex items-center" style={{ left: `${Math.min(90, (distance / 300) * 90)}%` }}>
          <div className="w-8 h-16 bg-indigo-200 rounded border-2 border-indigo-400 flex items-center justify-center">
            <span className="text-[10px] text-indigo-700 font-bold rotate-90 whitespace-nowrap">receptor</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-indigo-50 rounded-xl p-3 text-center">
          <div className="text-xs text-indigo-600">Relative Intensity</div>
          <div className="text-2xl font-bold text-indigo-700" data-testid="text-intensity">{intensity.toFixed(1)}%</div>
        </div>
        <div className="bg-indigo-50 rounded-xl p-3 text-center">
          <div className="text-xs text-indigo-600">Formula</div>
      ...
      <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-3 text-sm text-indigo-800">
        <strong>Key Concept:</strong> Doubling the distance reduces intensity to 1/4. Halving the distance increases intensity by 4×. This affects patient dose and image quality.
      </div>
    </div>
  );
}
...
export function AttenuationLayers() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="attenuation-layers">
      <h3 className="font-bold text-gray-900">Attenuation & Beam Interaction</h3>
      <p className="text-sm text-gray-600">See how different tissues absorb x-rays at varying thicknesses.</p>
      ...
      <div className="relative bg-gray-50 rounded-xl p-4 h-32 flex items-center">
        <div className="flex items-center w-full">
          <div className="flex-shrink-0 flex flex-col items-center">
            ...
            <div className="text-[10px] text-gray-500 mt-1">Source</div>
          </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-green-50 rounded-xl p-3 text-center">
          <div className="text-xs text-green-600">Transmitted</div>
          <div className="text-2xl font-bold text-green-700" data-testid="text-transmitted">{transmitted.toFixed(1)}%</div>
        </div>
        <div className="bg-red-50 rounded-xl p-3 text-center">
          <div className="text-xs text-red-600">Absorbed</div>
          <div className="text-2xl font-bold text-red-700" data-testid="text-absorbed">{absorbed.toFixed(1)}%</div>
        </div>
      </div>
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 text-sm text-blue-800">
        <strong>Key Concept:</strong> I = I₀ × e^(-μx). Higher atomic number and density = more attenuation. This is why bone appears white and air appears black on radiographs.
      </div>
    </div>
  );
}
...
export function SidMagnificationVisual() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="sid-magnification">
      <h3 className="font-bold text-gray-900">SID, OID & Magnification</h3>
      <p className="text-sm text-gray-600">Adjust SID and OID to see how they affect magnification and image size.</p>
      <div className="space-y-3">
        <div className="flex items-center gap-4">
          <span className="text-sm text-gray-500 w-12">SID:</span>
        ...
        <div className="flex items-center gap-4">
          <span className="text-sm text-gray-500 w-12">OID:</span>
      ...
      <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3 text-sm text-emerald-800">
        <strong>Key Concept:</strong> MF = SID/SOD. Increase SID or decrease OID to reduce magnification. Standard chest x-ray uses 72" (183 cm) SID to minimize heart magnification.
      </div>
    </div>
  );
}

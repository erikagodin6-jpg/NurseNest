  ...
  const contentMap: Record<string, Record<string, PageContent>> = {
    "social-worker": {
      ...
      "practice-questions": {
        ...
        faqs: [
          { q: "How many free practice questions are available?", a: "Free users get access to sample questions spanning ASWB exam domains. Our question bank currently has 25 questions and is actively expanding with new questions added regularly." },

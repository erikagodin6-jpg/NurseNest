...
function Dashboard() {
  ...
  return (
    <>
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-6" data-testid="text-admin-title">Pharmacy Technician Content Manager</h1>
      {loading ? (
...
function LessonForm({ item, onSave, onCancel }: { item?: any; onSave: () => void; onCancel: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="lesson-form">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Related Deck Slugs (comma-separated)</label>
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button type="button" onClick={onCancel} className="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-200" data-testid="button-cancel-lesson">Cancel</button>
      </div>
    </form>
  );
}
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="question-form">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Correct Index (0-based)</label>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Lesson Slug (optional)</label>
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button type="button" onClick={onCancel} className="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-200" data-testid="button-cancel-question">Cancel</button>
      </div>
    </form>
  );
}
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="flashcard-deck-form">
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button type="button" onClick={onCancel} className="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-200" data-testid="button-cancel-deck">Cancel</button>
      </div>
    </form>
  );
}
...
function ExamForm({ item, onSave, onCancel }: { item?: any; onSave: () => void; onCancel: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" data-testid="exam-form">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Question IDs (comma-separated)</label>
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button type="button" onClick={onCancel} className="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-200" data-testid="button-cancel-exam">Cancel</button>
      </div>
    </form>
  );
}
          ...
          {filtered.map(item => (
            <div key={item.id} className="bg-white rounded-xl border border-gray-100 p-4 flex items-center justify-between" data-testid={`admin-item-${item.id}`}>
              ...
              <div className="flex items-center gap-1">
                <button onClick={() => setEditingItem(item)} className="p-1.5 rounded-lg text-blue-500 hover:text-blue-700 hover:bg-blue-50 transition-colors" title="Edit" data-testid={`button-edit-${item.id}`}>

...
const PROFESSION_META: Record<string, {
  ...
  paramedic: {
    ...
    hubPath: "/paramedic-encyclopedia", color: "teal",
  ...
  mlt: {
    ...
    hubPath: "/mlt-encyclopedia", color: "purple",
  ...
  imaging: {
    ...
    hubPath: "/imaging-encyclopedia", color: "orange",
  ...
  "social-work": {
    ...
    hubPath: "/social-work-encyclopedia", color: "cyan",
  ...
  psychotherapy: {
    ...
    hubPath: "/psychotherapy-encyclopedia", color: "indigo",
  ...
  addictions: {
    ...
    hubPath: "/addictions-encyclopedia", color: "emerald",
  ...
  "occupational-therapy": {
    ...
    hubPath: "/occupational-therapy-encyclopedia", color: "pink",

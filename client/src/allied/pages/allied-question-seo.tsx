...
const PROFESSION_CONFIGS: Record<string, ProfessionConfig> = {
  rrt: {
    ...
    questionsIndexHref: "/rrt/questions",
  ...
  mlt: {
    ...
    questionsIndexHref: "/mlt/questions",
    lessonsHref: "/mlt/usa/lessons",
    examsHref: "/mlt/exams",
    flashcardsHref: "/mlt/usa/flashcards",
  ...
  imaging: {
    ...
    questionsIndexHref: "/imaging/questions",

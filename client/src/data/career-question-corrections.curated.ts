...
import { MLT_QUESTION_CORRECTIONS_BATCH05 } from "./career-question-corrections-mlt-batch05";
import { MLT_QUESTION_CORRECTIONS_BATCH06 } from "./career-question-corrections-mlt-batch06";
import { MLT_QUESTION_CORRECTIONS_BATCH07 } from "./career-question-corrections-mlt-batch07";
import { MLT_QUESTION_CORRECTIONS_BATCH08 } from "./career-question-corrections-mlt-batch08";
import { MLT_QUESTION_CORRECTIONS_BATCH09 } from "./career-question-corrections-mlt-batch09";
import { MLT_QUESTION_CORRECTIONS_BATCH10 } from "./career-question-corrections-mlt-batch10";
import { MLT_QUESTION_CORRECTIONS_BATCH11 } from "./career-question-corrections-mlt-batch11";
...
export const CAREER_QUESTION_CORRECTIONS:Record<string,CareerQuestionCorrection>={
  ...
  ...MLT_QUESTION_CORRECTIONS_BATCH05,
  ...MLT_QUESTION_CORRECTIONS_BATCH06,
  ...MLT_QUESTION_CORRECTIONS_BATCH07,
  ...MLT_QUESTION_CORRECTIONS_BATCH08,
  ...MLT_QUESTION_CORRECTIONS_BATCH09,
  ...MLT_QUESTION_CORRECTIONS_BATCH10,
  ...MLT_QUESTION_CORRECTIONS_BATCH11,

...
const questionLoaders: Record<string, () => Promise<CareerQuestion[]>> = {
  rrt: () => Promise.all([
    ...
    import("./rrt-questions-batch4").then(m => m.rrtQuestionsBatch4),
    import("./rrt-questions-batch5").then(m => m.rrtQuestionsBatch5),
    import("./rrt-questions-batch6").then(m => m.rrtQuestionsBatch6),
    import("./rrt-questions-batch7").then(m => m.rrtQuestionsBatch7),
    import("./rrt-questions-batch8").then(m => m.rrtQuestionsBatch8),
  ...
  paramedic: () => Promise.all([
    ...
    import("./paramedic-questions-batch2").then(m => m.paramedicQuestionsBatch2),
    import("./paramedic-questions-batch3").then(m => m.paramedicQuestionsBatch3),
  ...
  pharmacyTech: () => Promise.all([
    ...
    import("./pharmacy-tech-questions-batch5").then(m => m.pharmacyTechQuestionsBatch5),
    import("./pharmacy-tech-questions-batch6").then(m => m.pharmacyTechQuestionsBatch6),
    import("./pharmacy-tech-questions-batch7").then(m => m.pharmacyTechQuestionsBatch7),
    import("./pharmacy-tech-questions-batch8").then(m => m.pharmacyTechQuestionsBatch8),
    import("./pharmacy-tech-questions-batch9").then(m => m.pharmacyTechQuestionsBatch9),
  ...
  mlt: () => Promise.all([
    ...
    import("./mlt-questions-batch3").then(m => m.mltQuestionsBatch3),
    import("./mlt-questions-batch4").then(m => m.mltQuestionsBatch4),
  ...
  imaging: () => Promise.all([
    ...
    import("./imaging-questions-batch2").then(m => m.imagingQuestionsBatch2),
    import("./imaging-questions-batch3").then(m => m.imagingQuestionsBatch3),
    import("./imaging-questions-batch4").then(m => m.imagingQuestionsBatch4),
    import("./imaging-questions-batch5").then(m => m.imagingQuestionsBatch5),
    import("./imaging-questions-batch6").then(m => m.imagingQuestionsBatch6),
  ]).then(parts => parts.flat()),
  ...
  surgicalTechnologist: () => Promise.all([
    ...
    import("./surgical-technologist-questions-8").then(m => m.surgicalTechnologistQuestionsPart8),
    import("./surgical-technologist-questions-9").then(m => m.surgicalTechnologistQuestionsPart9),
    import("./surgical-technologist-questions-10").then(m => m.surgicalTechnologistQuestionsPart10),
    import("./surgical-technologist-questions-11").then(m => m.surgicalTechnologistQuestionsPart11),
  ]).then(parts => parts.flat()),

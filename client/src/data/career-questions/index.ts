...
const questionLoaders: Record<string, () => Promise<CareerQuestion[]>> = {
  ...
  socialWorker: () => Promise.all([
    ...
    import("./social-worker-questions-batch23").then(m => m.socialWorkerQuestionsBatch23),
    import("./social-worker-questions-batch24").then(m => m.socialWorkerQuestionsBatch24),
    import("./social-worker-questions-batch25").then(m => m.socialWorkerQuestionsBatch25),
  ...
  physiotherapyAssistant: () => Promise.all([
    ...
    import("./pta-questions-batch19").then(m => m.ptaQuestionsBatch19),
    import("./pta-questions-batch20").then(m => m.ptaQuestionsBatch20),
    import("./pta-questions-batch21").then(m => m.ptaQuestionsBatch21),
    import("./pta-questions-batch22").then(m => m.ptaQuestionsBatch22),
    import("./pta-questions-batch23").then(m => m.ptaQuestionsBatch23),
  ...
  occupationalTherapyAssistant: () => Promise.all([
    ...
    import("./ota-questions-batch11").then(m => m.otaQuestionsBatch11),
    import("./ota-questions-batch12").then(m => m.otaQuestionsBatch12),
    import("./ota-questions-batch13").then(m => m.otaQuestionsBatch13),
    import("./ota-questions-batch14").then(m => m.otaQuestionsBatch14),
    import("./ota-questions-batch15").then(m => m.otaQuestionsBatch15),

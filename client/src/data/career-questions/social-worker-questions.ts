export interface CareerQuestion {
  ...
  export const socialWorkerQuestions: CareerQuestion[] = [
    {
      id: "sw-001",
      stem: "A social worker is conducting an intake assessment with a new client who reports feeling overwhelmed by caregiving responsibilities for an elderly parent. Which intervention should the social worker prioritize first?",
      options: [
        "Refer the client to a support group for caregivers",
        "Conduct a comprehensive psychosocial assessment",
        "Arrange for respite care services immediately",
        "Recommend the client consider assisted living for the parent"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-002",
      stem: "During a home visit, a social worker observes that a 4-year-old child has multiple bruises in various stages of healing on the torso and upper arms. The parent explains the child is 'clumsy.' What is the social worker's primary legal and ethical obligation?",
      options: [
        "Document the observations and continue monitoring during future visits",
        "Confront the parent about the inconsistent explanation",
        "Report the suspected child abuse to the appropriate child protective services agency",
    ...
    {
      id: "sw-003",
      stem: "A client with a history of substance use disorder tells the social worker they had a relapse over the weekend but are committed to recovery. Which therapeutic approach is most appropriate?",
      options: [
        "Express disappointment to help the client understand the severity of relapse",
        "Use motivational interviewing to explore the client's ambivalence and reinforce commitment to change",
        "Immediately refer the client to an inpatient treatment program",
        "Terminate the therapeutic relationship due to noncompliance"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-004",
      stem: "A social worker in a hospital setting is working with a patient who has been diagnosed with a terminal illness. The patient expresses a desire to discontinue treatment. What should the social worker do first?",
      options: [
        "Encourage the patient to continue treatment for the sake of their family",
        "Assess the patient's understanding of their diagnosis, prognosis, and treatment options",
        "Contact the patient's family to inform them of the decision",
        "Refer the patient to a psychiatrist for evaluation of depression"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-005",
      stem: "Which of the following best describes the concept of 'person-in-environment' in social work practice?",
      options: [
        "Treating the individual without considering external factors",
        "Understanding that a person's behavior and well-being are influenced by the interaction between the individual and their environment",
        "Focusing primarily on environmental factors that affect behavior",
        "Assessing only the client's immediate family system"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-006",
      stem: "A social worker is facilitating a group for survivors of domestic violence. One member begins to share her experience, and another member starts crying and says she cannot listen anymore. What is the most appropriate group facilitation response?",
      options: [
        "Ask the crying member to leave the room until she can compose herself",
        "Stop the sharing member and move to a different topic",
        "Acknowledge both members' experiences and check in with the group about how to proceed",
        "Continue allowing the first member to share since it is her turn"
      ],
      correctIndex: 2,
    ...
    {
      id: "sw-007",
      stem: "A social worker is working with an adolescent client who discloses that they are being bullied at school. The client asks the social worker not to tell anyone. How should the social worker respond?",
      options: [
        "Promise to keep the information confidential to maintain trust",
        "Immediately contact the school principal without the client's knowledge",
        "Explain the limits of confidentiality and discuss options for addressing the situation together",
        "Tell the client that bullying is a normal part of adolescence"
      ],
      correctIndex: 2,
    ...
    {
      id: "sw-008",
      stem: "Which theoretical framework emphasizes examining how power, privilege, and oppression affect clients' lives and is central to anti-oppressive social work practice?",
      options: [
    ...
    {
      id: "sw-009",
      stem: "A social worker is developing a safety plan with a client who is experiencing suicidal ideation. Which element is MOST critical to include in the plan?",
      options: [
        "A list of the client's favorite hobbies",
        "Emergency contact numbers and crisis resources including 988 Suicide & Crisis Lifeline",
        "A schedule for regular therapy appointments",
        "A list of medications the client is taking"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-010",
      stem: "A social worker notices that a colleague is coming to work appearing intoxicated and has been making errors in client documentation. What is the most appropriate course of action?",
      options: [
        "Ignore the behavior since it is not the social worker's responsibility",
        "Confront the colleague privately and offer to help",
        "Report the concern to the appropriate supervisor or regulatory body",
        "Cover for the colleague's errors to protect clients"
      ],
      correctIndex: 2,
    ...
    {
      id: "sw-011",
      stem: "In Erikson's stages of psychosocial development, what is the primary developmental task of adolescence?",
      options: [
        "Trust vs. Mistrust",
    ...
    {
      id: "sw-012",
      stem: "A social worker is conducting a family session and notices that one family member consistently interrupts others and dominates the conversation. Which systemic intervention is most appropriate?",
      options: [
        "Ask the dominant member to leave the session",
        "Ignore the behavior and allow the session to continue naturally",
        "Use structural family therapy techniques to establish boundaries and redirect communication patterns",
        "Side with the other family members to counterbalance the dominant member"
      ],
      correctIndex: 2,
    ...
    {
      id: "sw-013",
      stem: "What is the primary purpose of the DSM-5 in social work practice?",
      options: [
        "To prescribe medication for mental health conditions",
        "To provide a standardized classification system for diagnosing mental health disorders",
        "To determine eligibility for social services",
        "To replace the biopsychosocial assessment"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-014",
      stem: "A social worker is working with a refugee family that has experienced significant trauma. Which culturally responsive practice principle is MOST important to apply?",
      options: [
        "Assume all refugees have the same cultural background and needs",
        "Avoid discussing the trauma to prevent retraumatization",
        "Recognize the family's cultural strengths and incorporate culturally specific healing practices alongside Western interventions",
        "Require the family to assimilate to the dominant culture as quickly as possible"
      ],
      correctIndex: 2,
    ...
    {
      id: "sw-015",
      stem: "A community social worker is conducting a needs assessment for a neighborhood with high rates of food insecurity. Which approach would be most effective for identifying community needs and strengths?",
      options: [
        "Reviewing census data exclusively",
        "Conducting interviews only with community leaders",
        "Using participatory action research that involves community members as co-researchers",
        "Surveying only service providers in the area"
      ],
      correctIndex: 2,
    ...
    {
      id: "sw-016",
      stem: "Which of the following describes a dual relationship in social work?",
      options: [
        "Working with two clients from the same family",
        "Having a professional relationship and a personal or business relationship with the same client",
        "Providing services to a client in two different settings",
        "Collaborating with another professional on a client's case"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-017",
      stem: "A social worker is providing case management services to a client with severe and persistent mental illness. The client has been stable on medication but wants to stop taking it. What is the most appropriate response?",
      options: [
        "Insist the client continue medication to maintain stability",
        "Respect the client's autonomy while educating about potential risks and collaborating on a plan",
        "Discharge the client from services for noncompliance",
        "Contact the client's family to intervene"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-018",
      stem: "What is the primary goal of strengths-based practice in social work?",
      options: [
        "To identify and fix client deficits and problems",
        "To build on clients' existing resources, capacities, and resilience to promote positive change",
        "To minimize the importance of environmental challenges",
        "To ensure clients become independent of all support systems"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-019",
      stem: "A social worker receives a subpoena for a client's records. What should the social worker do first?",
      options: [
        "Immediately release all client records to comply with the subpoena",
        "Destroy the records to protect client confidentiality",
        "Consult with legal counsel and notify the client before responding to the subpoena",
        "Ignore the subpoena since client records are always confidential"
      ],
      correctIndex: 2,
    ...
    {
      id: "sw-020",
      stem: "In the transtheoretical model of change (Stages of Change), a client who recognizes they have a problem but has not yet taken steps to address it is in which stage?",
      options: [
        "Precontemplation",
        "Contemplation",
        "Preparation",
    ...
    {
      id: "sw-021",
      stem: "A social worker is providing services to an elderly client who lives alone and has been found wandering in the neighborhood on multiple occasions. The client refuses services and insists on remaining independent. What should the social worker consider?",
      options: [
        "Respect the client's wishes without further action since they have the right to self-determination",
        "Assess the client's decision-making capacity and evaluate the level of risk to determine appropriate next steps",
        "Immediately arrange for the client to be placed in a nursing home",
        "Contact the client's children to take over decision-making"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-022",
      stem: "Which of the following is a key component of trauma-informed care?",
      options: [
        "Requiring clients to provide detailed accounts of their trauma during the first session",
        "Creating an environment of safety, trustworthiness, choice, collaboration, and empowerment",
        "Avoiding any discussion of past experiences to prevent retraumatization",
        "Using confrontational techniques to help clients process their emotions"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-023",
      stem: "A social worker is developing a discharge plan for a hospitalized patient. Which of the following should be included in a comprehensive discharge plan?",
      options: [
        "Only the patient's medication list",
        "A referral to follow-up care, community resources, support systems, and a plan for continuity of care",
        "The patient's insurance information",
        "A detailed description of the patient's hospital stay"
      ],
      correctIndex: 1,
    ...
    {
      id: "sw-024",
      stem: "What does the NASW Code of Ethics identify as the primary mission of social work?",
      options: [
        "Diagnosing and treating mental health disorders",
        "Enhancing human well-being and helping meet basic needs, with particular attention to the vulnerable and oppressed",
        "Providing financial assistance to individuals in poverty",
    ...
    {
      id: "sw-025",
      stem: "A social worker is working with a couple where one partner has disclosed infidelity. The other partner demands to know all the details. How should the social worker handle this situation?",
      options: [
        "Require the unfaithful partner to disclose everything to support transparency",
        "Refuse to discuss the infidelity in session and redirect to other topics",
        "Help the couple establish ground rules for disclosure and process emotions in a safe, structured manner",
        "Recommend immediate separation as the best course of action"
      ],
      correctIndex: 2,

...
export const rpnExpansionGQuestions: ExamQuestion[] = [
  {
    ...
    o: ["Hold the medication and notify the healthcare provider", "Administer the medication as ordered", "Administer half the dose and reassess in 1 hour", "Administer the medication with a glass of orange juice"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Maintain adequate sodium and fluid intake and have lithium levels checked regularly", "Restrict sodium intake to prevent fluid retention", "Take the medication only when mood symptoms worsen", "Avoid all dairy products while taking this medication"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Metformin should be held before and for 48 hours after the procedure due to risk of lactic acidosis", "Metformin can be continued safely during the procedure", "The dose of metformin should be doubled on the day of the scan", "Metformin should be taken with the contrast dye to stabilize blood glucose"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Administer naloxone (Narcan) as prescribed and stimulate the client", "Continue to monitor the client since drowsiness is expected after morphine", "Administer another dose of morphine for breakthrough pain", "Position the client flat and wait for the medication to wear off"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Nystagmus, ataxia, and slurred speech", "Improved seizure control with no adverse effects", "Hypertension and tachycardia", "Polyuria and polydipsia"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Shake the inhaler, attach the spacer, press the canister, then inhale slowly and deeply", "Inhale quickly and forcefully immediately after pressing the canister without a spacer", "Hold the inhaler 15 cm from the mouth and inhale through the nose", "Take two rapid puffs in succession without waiting between doses"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Do not stop suddenly; the dose must be tapered gradually under provider supervision", "It is safe to stop prednisone abruptly at any time", "Continue taking the full dose indefinitely for best results", "Switch to taking it every other day without consulting the provider"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Open the airway using a jaw-thrust maneuver and provide rescue breaths", "Begin chest compressions immediately", "Move the victim to a more comfortable location", "Wait for emergency medical services to arrive before intervening"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Epinephrine (adrenaline) 0.3 mg intramuscular into the lateral thigh", "Diphenhydramine (Benadryl) 50 mg IV", "Hydrocortisone 100 mg IV", "Albuterol nebulizer treatment"],
    a: 0,
  ...
  },
  {
    ...
    o: ["N-acetylcysteine (Mucomyst) as the antidote for acetaminophen toxicity", "Activated charcoal to absorb the remaining medication", "Flumazenil to reverse the sedative effects", "Naloxone to reverse the respiratory depression"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Subarachnoid hemorrhage requiring emergent evaluation", "Migraine headache requiring analgesics", "Tension headache from muscle strain", "Sinusitis from upper respiratory infection"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Kussmaul respirations, fruity breath odour, blood glucose of 28 mmol/L, and pH 7.18", "Shallow respirations, blood glucose of 4.5 mmol/L, and pH 7.45", "Bradypnea, blood glucose of 6.0 mmol/L, and pH 7.50", "Normal respirations, blood glucose of 5.5 mmol/L, and pH 7.40"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Hypovolemic shock from massive fluid shifts into interstitial spaces", "Infection from bacterial colonization of the burn wounds", "Contractures from scar tissue formation", "Hyperkalemia from excessive IV fluid administration"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Implement neutropenic precautions including strict hand hygiene and avoiding fresh flowers and raw foods", "Encourage the client to have visitors to maintain emotional well-being", "Administer live vaccines to boost the client's immune response", "Encourage the client to eat sushi and salads for protein and vitamins"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Ondansetron (Zofran) combined with dexamethasone, administered before and after chemotherapy", "Bismuth subsalicylate (Pepto-Bismol) taken orally as needed", "Ginger tea only, as natural remedies are preferred for chemotherapy nausea", "Metoclopramide after chemotherapy completion only"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Monitor for signs of cardiotoxicity including heart failure symptoms and obtain baseline echocardiogram", "Monitor liver function tests weekly", "Assess for hearing loss after each treatment", "Check serum calcium levels daily"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Skin in the treatment area may become red and irritated; avoid lotions, powders, and sun exposure to the area", "Radiation effects are limited to the treatment day and cause no lasting skin changes", "Apply generous amounts of perfumed lotion to the treatment area to keep skin moisturised", "Radiation therapy does not cause fatigue or dietary changes"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Provide oral care with a soft-bristle toothbrush and bland rinses such as normal saline or sodium bicarbonate", "Instruct the client to use an alcohol-based mouthwash for disinfection", "Encourage hot spicy foods to stimulate appetite", "Defer oral care until the ulcers heal to avoid further irritation"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Demonstrate postoperative exercises including ankle pumps, quad sets, and the use of an incentive spirometer", "Inform the client they will not need to perform any exercises after surgery", "Advise the client to eat a large meal the morning of surgery", "Tell the client pain medication will not be available in the first 24 hours"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Internal hemorrhage requiring immediate assessment and intervention", "Normal recovery from general anaesthesia", "An adverse reaction to antiemetic medication", "Dehydration from preoperative NPO status alone"],
    a: 0,
  ...
  },
  {
    ...
    o: ["ASA inhibits platelet aggregation and increases the risk of surgical bleeding", "ASA increases blood pressure during anaesthesia", "ASA causes hyperglycemia during the perioperative period", "ASA has no effect on surgical outcomes"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Immediately inform the surgeon, halt wound closure, and initiate a recount and search", "Document the discrepancy and report it after the surgery is complete", "Assume the sponge was discarded and allow wound closure to proceed", "Ask another nurse to recount without informing the surgeon"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Phantom limb pain is a real neurological phenomenon and should be treated with appropriate pain management", "The client is confused and should be reoriented to the amputation", "The pain is psychosomatic and requires psychiatric referral", "Phantom pain does not exist and the client is seeking attention"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Numbness and tingling in the fingers, capillary refill greater than 3 seconds, and inability to move fingers", "Warmth and slight swelling of the fingers on the casted arm", "Mild itching under the cast", "Visible cast padding at the proximal and distal edges"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Lumbar disc herniation compressing the sciatic nerve", "Muscle strain from improper lifting technique", "Osteoarthritis of the lumbar spine", "Urinary tract infection causing referred back pain"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Compartment syndrome requiring emergency fasciotomy", "Normal postoperative swelling that will resolve with elevation", "Deep vein thrombosis requiring anticoagulation", "Infection at the surgical site"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Respect the client's autonomy and right to confidentiality while encouraging the client to share when ready", "Tell the family the diagnosis despite the client's wishes because they have a right to know", "Document the request and ignore it because family members always need to be informed", "Refuse to care for the client because the request creates an ethical conflict"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Respect the client's advance directive, ensure comfort measures, and notify the healthcare provider of the client's wishes", "Administer the blood transfusion because preserving life overrides the advance directive", "Ask the family to override the client's decision", "Delay the decision until the client becomes unconscious and then transfuse"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Assess the client, notify the healthcare provider, and complete an incident report", "Document the correct dose was given and do not report the error", "Tell only the charge nurse and request they keep it confidential", "Wait 24 hours to see if the client develops any problems before reporting"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Wait for a certified medical interpreter and do not use the child to relay medical information", "Use the child to translate since no other option is available", "Provide written instructions in English and assume the client will find a translator later", "Use hand gestures and pictures to communicate the discharge instructions fully"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Decline the request and explain that a court order or client consent is required before releasing the sample", "Draw the blood sample immediately because the police have authority in criminal investigations", "Draw the blood and give it to the officer if the nurse suspects the client was drinking", "Contact the client's family for consent to draw the blood"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Acknowledge the client's suffering, advocate for improved pain management, and consult the palliative care team", "Agree to help the client and increase the opioid dose beyond what is prescribed", "Tell the client they should not talk about dying and change the subject", "Ignore the request and continue routine care without addressing the statement"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Verify the result, assess the client for hypoglycemia symptoms, and intervene with fast-acting glucose immediately", "Thank the PSW and document the result without further action", "Ask the PSW to recheck the glucose in 1 hour", "Instruct the PSW to give the client juice without the nurse assessing first"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Explain that personal beliefs do not constitute grounds for refusing a client assignment and the RN must provide non-discriminatory care", "Immediately reassign the client to accommodate the RN's preference", "Allow all nurses to choose clients based on personal preferences", "Report the RN to the regulatory body without discussing the issue"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Contact the pharmacy to obtain the correct dose and do not administer until the discrepancy is resolved", "Cut the 50 mg tablet in half and administer it", "Administer the 50 mg tablet and document the discrepancy", "Hold the medication until the next shift and let them deal with it"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Verify the client's identity using two identifiers, recheck the armband, and resolve the discrepancy before proceeding with any care", "Proceed with admission using the armband information since it was applied at registration", "Ask a family member to confirm the client's identity", "Apply a new armband with the name the client provided without further verification"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Assess the client for injuries before moving them", "Help the client back into bed immediately to prevent further falls", "Call the healthcare provider before assessing the client", "Complete an incident report and then check the client"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Check circulation and skin integrity every 2 hours, release the restraint for range of motion, and offer toileting and nutrition", "Apply the restraint as tightly as possible to prevent the client from removing it", "Tie the restraint to the side rail so it moves with the bed position", "Check the restraint once per shift to minimise disturbance to the client"],
    a: 0,
  ...
  },
  {
    ...
    o: ["Verify NG tube placement by checking pH of aspirate and confirming the tube marking at the naris", "Administer the medication without checking placement since the tube was verified on insertion", "Flush the tube with cola to ensure patency", "Crush all medications together and administer them simultaneously through the tube"],
    a: 0,

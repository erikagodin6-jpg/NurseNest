...
export const clinicalConditionsBatchNLessons: Record<string, LessonContent> = {
  "bppv-management-rpn": {
    ...
    management: [
      "Assist with canalith repositioning maneuvers (Epley maneuver) as directed by the RN or physiotherapist",
  ...
  "menieres-disease-rpn": {
    ...
    quiz: [
      ...
      { question: "Which dietary restriction should the RPN reinforce for a patient with Meniere's disease?", options: ["Low-protein diet", "Low-sodium diet (<2g/day)", "High-potassium diet", "Gluten-free diet"], correct: 1, rationale: "Sodium restriction reduces endolymphatic pressure and is a first-line management strategy for Meniere's disease." },
  ...
  "menieres-disease-rn": {
    ...
    quiz: [
      { question: "The RN is assessing a patient during a Meniere's disease episode. Which finding differentiates this from BPPV?", options: ["Vertigo triggered by head position changes", "Brief episodes lasting under 30 seconds", "Fluctuating hearing loss with tinnitus", "Positive Dix-Hallpike test"], correct: 2, rationale: "Meniere's disease is characterized by fluctuating hearing loss and tinnitus, which are absent in BPPV. Meniere's episodes last 20 minutes to hours and are not triggered by specific head positions." },
      { question: "A patient on hydrochlorothiazide for Meniere's disease reports muscle weakness and fatigue. Which lab should the RN check first?", options: ["Troponin", "Serum potassium", "Hemoglobin A1C", "BNP"], correct: 1, rationale: "Hydrochlorothiazide causes potassium wasting. Muscle weakness and fatigue are classic hypokalemia symptoms requiring urgent potassium level assessment." },
  ...
  "labyrinthitis-rpn": {
    ...
    quiz: [
      ...
      { question: "Which finding should the RPN report immediately in a patient with suspected labyrinthitis?", options: ["Mild nausea", "Gradual improvement in vertigo after 3 days", "Fever of 39.5°C with neck stiffness", "Preference to lie on the unaffected side"], correct: 2, rationale: "High fever with neck stiffness suggests bacterial meningitis with secondary labyrinthitis, a medical emergency requiring immediate intervention." },
      { question: "Which environmental modification should the RPN implement during an acute labyrinthitis episode?", options: ["Bright lighting and television to distract the patient", "Quiet, dimly lit environment with minimal sensory stimulation", "Frequent position changes to promote vestibular compensation", "Open windows for fresh air circulation"], correct: 1, rationale: "Reducing visual and auditory stimulation helps minimize the sensory mismatch that worsens vertigo and nausea during acute labyrinthitis." }
    ]
  },

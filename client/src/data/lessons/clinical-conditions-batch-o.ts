...
export const clinicalConditionsBatchOLessons: Record<string, LessonContent> = {
  "rhinosinusitis-rpn": {
    title: "Rhinosinusitis: RPN Monitoring & Supportive Care",
    cellular: {
      title: "Pathophysiology of Rhinosinusitis",
      content: "Rhinosinusitis is inflammation of the nasal mucosa and paranasal sinuses. Viral rhinosinusitis (rhinovirus, coronavirus, influenza, adenovirus) causes mucosal edema that obstructs sinus ostia, impairing mucociliary clearance and leading to mucus accumulation. Complete recovery occurs in 99% of viral cases within 7–10 days. In a small subset, bacterial superinfection develops when sinus ostia obstruction allows colonization by Streptococcus pneumoniae, Haemophilus influenzae, or Moraxella catarrhalis. Prolonged inflammation can progress to an anaerobic phase with organisms such as Peptostreptococcus, Prevotella, and Fusobacterium species. The RPN monitors symptoms, administers medications as ordered, educates on supportive measures, and reports signs of deterioration."
    },
    riskFactors: [
    ...
    quiz: [
      { question: "Which finding should the RPN report immediately in a patient with rhinosinusitis?", options: ["Clear nasal discharge for 5 days", "Orbital swelling and visual changes", "Mild facial pressure over maxillary sinus", "Low-grade fever of 37.8°C"], correct: 1, rationale: "Orbital swelling and visual changes are red flags that may indicate orbital complications of sinusitis requiring urgent medical evaluation." },
  ...
  "pharyngitis-management-rn": {
    ...
    quiz: [
      { question: "A patient scores 4/4 on Centor criteria with a negative rapid strep test. What should the RN anticipate?", options: ["No further testing needed; treat symptomatically", "Throat culture to confirm given high clinical suspicion", "Start antiviral therapy", "Discharge with no follow-up"], correct: 1, rationale: "RADT sensitivity is 70–90%, so a negative RADT with high clinical suspicion (4/4 Centor criteria) warrants confirmatory throat culture before ruling out GAS." },

...
export const generatedBatch110Lessons: Record<string, LessonContent> = {
  ...
  "shoulder-dystocia": {
    ...
    cellular: {
      title: "Pathophysiology of Shoulder Dystocia",
      content: "Shoulder dystocia is an obstetric emergency that occurs when the fetal anterior shoulder becomes impacted behind the maternal pubic symphysis after delivery of the fetal head. This mechanical obstruction prevents delivery of the fetal body and creates a time-critical situation due to compression of the umbilical cord between the fetal body and the maternal pelvis.\n\nThe impaction occurs because the bisacromial diameter (distance between the fetal shoulders) is too large to pass through the anteroposterior diameter of the pelvic inlet. The anterior shoulder lodges above the pubic symphysis while the posterior shoulder may be arrested at the sacral promontory.\n\nOnce the head delivers, the umbilical cord is compressed between the fetal trunk and the birth canal, interrupting fetal oxygen supply. Fetal acidosis develops rapidly — the window for safe delivery is approximately 5-7 minutes. Beyond this, the risk of permanent injury increases significantly.\n\nBrachial plexus injury (Erb's palsy affecting C5-C6, or Klumpke's palsy affecting C8-T1) occurs from lateral traction on the fetal neck during delivery maneuvers. Fractures of the clavicle or humerus may also occur. Maternal complications include postpartum hemorrhage from uterine atony, vaginal lacerations, and symphyseal separation."
    },
    riskFactors: [
      "Fetal macrosomia (estimated fetal weight >4000g, or >4500g in diabetic mothers)",
      "Maternal gestational diabetes or diabetes mellitus",
      "Maternal obesity",
    ...
    diagnostics: [
      ...
      "Failure of external rotation of the fetal head",
      "Inability to deliver the anterior shoulder with gentle downward traction",
      "Recognition is clinical and immediate — no laboratory or imaging diagnostics during the event"
    ],
    management: [
      "Call for additional help immediately (additional nurses, anesthesia, pediatrics, obstetrician)",
      "McRoberts maneuver: hyperflexion of maternal thighs against abdomen to increase AP diameter of pelvis",
      "Suprapubic pressure: apply downward and lateral pressure above the pubic symphysis to dislodge anterior shoulder",
      "Rubin maneuver: rotate the anterior shoulder toward the fetal chest to reduce bisacromial diameter",
      "Woods corkscrew maneuver: rotate the posterior shoulder 180° to disimpact",
      "Delivery of the posterior arm: sweep the posterior arm across the fetal chest",
      "Gaskin maneuver: move mother to all-fours position to increase pelvic diameters"
    ],
    nursingActions: [
      "Note the exact time of head delivery and document all maneuvers with timestamps",
      "Assist with McRoberts positioning by holding the patient's legs in hyperflexion",
      "Apply suprapubic pressure as directed (NOT fundal pressure, which worsens impaction)",
      "Prepare for neonatal resuscitation — have warmer, suction, bag-mask ready",
      "Ensure neonatal team is at bedside",
      "Document sequence of maneuvers, personnel present, and neonatal outcomes"
    ],
    signs: {
      left: [
        "Turtle sign (fetal head retracts after delivery)",
        "Failure of restitution/external rotation",
        "Inability to deliver with gentle traction",
        "Prolonged head-to-body delivery interval"
      ],
      right: [
        "Fetal bradycardia during impaction",
        "Brachial plexus injury signs in neonate (limp arm)",
        "Clavicle fracture (crepitus, asymmetric Moro reflex)",
        "Maternal postpartum hemorrhage"
      ]
    },
    medications: [
      { name: "Oxytocin (Pitocin)", type: "Uterotonic", action: "Administered postpartum to promote uterine contraction and prevent hemorrhage following the traumatic delivery", sideEffects: "Uterine hyperstimulation, water intoxication with prolonged high-dose infusion, hypotension with rapid IV push", contra: "Active shoulder dystocia (do not use to increase contractions during impaction)", pearl: "Resume or initiate after delivery for hemorrhage prevention; during shoulder dystocia, focus is on maneuvers, not medications" }
    ],
    pearls: [
      "NEVER apply fundal pressure during shoulder dystocia — it worsens the impaction and increases brachial plexus injury risk",
      "The mnemonic HELPERR: Help, Evaluate for episiotomy, Legs (McRoberts), Pressure (suprapubic), Enter (rotational maneuvers), Remove posterior arm, Roll (Gaskin)",
      "Most shoulder dystocias cannot be predicted — only 50% occur in macrosomic infants",
      "Document the event thoroughly including time of head delivery, all maneuvers attempted, and neonatal condition"
    ],
    quiz: [
      { question: "After delivery of the fetal head, the nurse observes the head retract tightly against the perineum. What is the nurse's immediate action?", options: ["Apply fundal pressure to assist delivery", "Call for help and assist with McRoberts maneuver", "Begin neonatal resuscitation", "Have the mother begin pushing forcefully"], correct: 1, rationale: "The turtle sign indicates shoulder dystocia. The immediate response is to call for help and initiate McRoberts maneuver (maternal leg hyperflexion). Fundal pressure is absolutely contraindicated as it worsens impaction." },
      { question: "During management of shoulder dystocia, a nurse is directed to apply suprapubic pressure. Where should the pressure be directed?", options: ["On the uterine fundus downward", "Above the pubic symphysis, downward and lateral", "On the maternal abdomen bilaterally", "On the fetal head to assist rotation"], correct: 1, rationale: "Suprapubic pressure is applied above the pubic symphysis in a downward and lateral direction to dislodge the anterior shoulder from behind the symphysis. Fundal pressure is contraindicated." }
    ]
  },
  ...
  "umbilical-cord-complications": {
    ...
    cellular: {
      title: "Pathophysiology of Umbilical Cord Complications",
  ...
  "pediatric-dehydration": {
    ...
    cellular: {
      ...
      content: "Dehydration in pediatric patients occurs when fluid output exceeds fluid intake, resulting in a deficit of total body water. Children are more susceptible to dehydration than adults due to their higher body surface area-to-weight ratio (leading to greater insensible water losses), higher metabolic rate, immature renal concentrating ability, and dependence on caregivers for fluid intake.\n\nInfants have the highest total body water content (approximately 75-80% of body weight compared to 60% in adults), and a larger proportion of their body water is in the extracellular compartment, making them particularly vulnerable to fluid shifts and losses.\n\nDehydration is classified by severity: mild (3-5% weight loss), moderate (6-9% weight loss), and severe (≥10% weight loss). It is also classified by type based on serum sodium: isotonic/isonatremic (Na 130-150 mEq/L, most common at 80%), hypotonic/hyponatremic (Na <130 mEq/L), or hypertonic/hypernatremic (Na >150 mEq/L).\n\nThe most common cause of dehydration in children worldwide is acute gastroenteritis (viral or bacterial). As fluid losses continue, compensatory mechanisms activate: the sympathetic nervous system increases heart rate and redirects blood flow to vital organs, ADH increases water reabsorption, and the renin-angiotensin-aldosterone system conserves sodium and water. When these mechanisms are overwhelmed, hypovolemic shock develops, manifesting as hypotension, altered mental status, and end-organ damage."
    },
    riskFactors: [
      "Age <12 months (highest risk)",
      "Acute gastroenteritis (vomiting and diarrhea)",
      "Fever (increases insensible losses by 10% per degree Celsius)",
      "Inability to drink or refusal to eat/drink",
      "Diabetic ketoacidosis",
      "Burns or large wounds",
      "Excessive sweating from physical activity in heat"
    ],
    diagnostics: [
      "Weight comparison to recent well-child weight (most accurate assessment of dehydration percentage)",
      "Clinical assessment: capillary refill time >2 seconds, decreased skin turgor, dry mucous membranes",
      "Serum electrolytes, BUN, creatinine (BUN:creatinine ratio >20:1 suggests dehydration)",
      "Urine specific gravity >1.020 and decreased urine output",
      "Serum bicarbonate <17 mEq/L suggests significant dehydration with metabolic acidosis"
    ],
    management: [
      "Mild-moderate dehydration: oral rehydration therapy (ORT) with electrolyte solution (Pedialyte) — 50-100 mL/kg over 4 hours",
      "Severe dehydration: IV fluid resuscitation with isotonic crystalloid (normal saline or LR) 20 mL/kg bolus over 20 minutes, repeat as needed",
      "Replace ongoing losses mL-for-mL with oral electrolyte solution",
      "Reintroduce age-appropriate diet as soon as tolerated — do NOT withhold feeds",
      "Ondansetron for vomiting may facilitate oral rehydration and prevent IV placement",
      "Monitor for signs of shock and escalate to intensive care if needed"
    ],
    nursingActions: [
      "Obtain accurate weight in kilograms and compare to last known well weight",
      "Assess dehydration severity: fontanelle, mucous membranes, skin turgor, capillary refill, tear production, mental status",
      "Administer oral rehydration solution in small, frequent volumes (5 mL every 1-2 minutes via syringe)",
      "Monitor strict intake and output; weigh diapers (1g = 1mL urine)",
      "Reassess hydration status after each fluid bolus or rehydration period",
      "Educate caregivers on signs of dehydration and when to return to emergency care"
    ],
    signs: {
      left: [
        "Decreased urine output (<1 mL/kg/hr in infants)",
        "Dry mucous membranes and absent tears",
    ...
    medications: [
      { name: "Ondansetron (Zofran)", type: "5-HT3 receptor antagonist antiemetic", action: "Blocks serotonin receptors in the chemoreceptor trigger zone and vagal afferents to prevent vomiting, facilitating oral rehydration", sideEffects: "Headache, constipation, QT prolongation (rare), dizziness", contra: "Congenital long QT syndrome, concurrent use of QT-prolonging medications", pearl: "A single oral dissolving tablet (ODT) can prevent vomiting long enough for successful oral rehydration and avoid IV placement; dose 0.15 mg/kg" }
    ],
    pearls: [
      "Oral rehydration therapy is as effective as IV fluids for mild-moderate dehydration and is the preferred initial approach",
      "Hypotension is a late sign of dehydration in children — tachycardia is an earlier and more reliable indicator",
      "Hypernatremic dehydration requires slow correction (decrease Na by no more than 0.5 mEq/L/hour) to prevent cerebral edema",
      "Weight loss is the gold standard for assessing dehydration severity: calculate percent weight change from last known weight"
    ],
    quiz: [
      { question: "An 8-month-old presents with 5 days of diarrhea, sunken fontanelle, absent tears, and tachycardia. The infant's last known weight was 8 kg and current weight is 7.3 kg. What is the estimated severity of dehydration?", options: ["Mild (3-5%)", "Moderate (6-9%)", "Severe (≥10%)", "No significant dehydration"], correct: 1, rationale: "Weight loss = (8 - 7.3)/8 × 100 = 8.75%, which falls in the moderate (6-9%) dehydration range. Clinical signs (sunken fontanelle, absent tears, tachycardia) are consistent with moderate dehydration." },
      { question: "Which intervention is the priority for a child with severe dehydration and signs of hypovolemic shock?", options: ["Oral rehydration therapy with Pedialyte", "IV bolus of normal saline 20 mL/kg over 20 minutes", "Oral ondansetron to control vomiting", "Maintenance IV fluids with D5 1/2 NS"], correct: 1, rationale: "Severe dehydration with shock requires immediate IV isotonic fluid resuscitation with 20 mL/kg normal saline bolus. Oral rehydration is insufficient for severe dehydration, and maintenance fluids do not address the immediate volume deficit." }
    ]
  },
  ...
  "sudden-infant-death-syndrome": {
    ...
    cellular: {
      title: "Pathophysiology of Sudden Infant Death Syndrome",
  ...
  "pediatric-respiratory-distress": {
    ...
    cellular: {
      title: "Pathophysiology of Pediatric Respiratory Distress",
  ...
  "major-depressive-disorder": {
    ...
    cellular: {
      title: "Pathophysiology of Major Depressive Disorder",
      content: "Major Depressive Disorder (MDD) is a complex neurobiological condition involving dysregulation of multiple neurotransmitter systems, neuroendocrine pathways, neuroinflammatory processes, and structural brain changes. It is characterized by persistent depressed mood or anhedonia lasting at least 2 weeks, with significant functional impairment.\n\nThe monoamine hypothesis, the earliest neurochemical model, proposes that depression results from deficient serotonin (5-HT), norepinephrine (NE), and/or dopamine activity in key brain circuits. While oversimplified, this model remains the basis for most pharmacological treatments. Serotonin regulates mood, sleep, and appetite; norepinephrine influences energy, attention, and motivation; dopamine mediates pleasure and reward.\n\nMore recent research has identified the role of the hypothalamic-pituitary-adrenal (HPA) axis in depression. Chronic stress leads to sustained cortisol elevation, which causes hippocampal neuronal atrophy, reduced neurogenesis, and impaired neuroplasticity. Brain imaging studies consistently show reduced hippocampal volume and decreased prefrontal cortex activity in depressed patients.\n\nNeuroinflammation is increasingly recognized as a contributing factor. Elevated pro-inflammatory cytokines (IL-6, TNF-alpha, CRP) are found in depressed patients. These cytokines decrease tryptophan availability (the precursor to serotonin), activate the HPA axis, and directly impair neuroplasticity. Glutamate and GABA imbalances, epigenetic modifications, and altered gut-brain axis signaling also contribute to the multifactorial pathology."
    },
    riskFactors: [
      "Family history of depression (first-degree relative increases risk 2-3 fold)",
      "Personal history of prior depressive episodes (50% recurrence after first episode)",
      "Chronic medical illness (diabetes, cancer, cardiovascular disease, chronic pain)",
      ...
      "Major life stressors (loss, divorce, unemployment)"
    ],
    diagnostics: [
      "DSM-5 criteria: ≥5 symptoms for ≥2 weeks including depressed mood OR anhedonia (SIG-E-CAPS mnemonic)",
      "PHQ-9 screening tool: scores ≥10 suggest moderate depression requiring treatment",
      "Assess for suicidal ideation using direct questioning: intent, plan, means, timeline",
      "Rule out medical causes: thyroid function (TSH), CBC, metabolic panel, B12, folate",
    ...
    management: [
      "Pharmacotherapy: SSRIs are first-line (fluoxetine, sertraline, escitalopram); therapeutic effect takes 4-6 weeks",
      "Cognitive Behavioral Therapy (CBT) alone or in combination with medication",
      "Electroconvulsive therapy (ECT) for severe, treatment-resistant depression or when rapid response is needed",
      "Safety planning for patients with suicidal ideation: means restriction, crisis contacts, coping strategies",
      "Regular exercise, sleep hygiene, and structured daily activities as adjunctive measures",
      "Close follow-up during the first 4-6 weeks of medication initiation (highest risk period for suicide)"
    ],
    nursingActions: [
      "Assess suicide risk at every encounter using a standardized tool (C-SSRS, PHQ-9 item 9)",
      "Build therapeutic relationship through active listening, empathy, and non-judgmental presence",
      "Monitor for medication side effects and educate patient about expected timeline for improvement",
      "Observe for increased energy without mood improvement in early treatment (paradoxical increased suicide risk)",
      "Encourage adherence to treatment plan and scheduled follow-up appointments",
      "Implement 1:1 safety monitoring for actively suicidal patients in inpatient settings"
    ],
    signs: {
      left: [
      ...
      right: [
        ...
        "Social withdrawal and decreased self-care"
      ]
    },
    medications: [
      { name: "Sertraline (Zoloft)", type: "Selective Serotonin Reuptake Inhibitor (SSRI)", action: "Selectively blocks reuptake of serotonin at the presynaptic neuron, increasing serotonin availability in the synaptic cleft", sideEffects: "GI upset (nausea, diarrhea), sexual dysfunction, headache, insomnia, weight changes, serotonin syndrome (with drug interactions)", contra: "Concurrent use with MAOIs (wait 14 days), concurrent use with pimozide or thioridazine", pearl: "Takes 4-6 weeks for full therapeutic effect; educate patients not to stop abruptly (taper to avoid discontinuation syndrome)" },
      { name: "Bupropion (Wellbutrin)", type: "Norepinephrine-dopamine reuptake inhibitor (NDRI)", action: "Inhibits reuptake of norepinephrine and dopamine; does not affect serotonin", sideEffects: "Insomnia, dry mouth, agitation, headache, seizure risk (dose-dependent)", contra: "Seizure disorder, eating disorders (bulimia, anorexia — increased seizure risk), concurrent MAOI use", pearl: "Unique among antidepressants: does NOT cause sexual dysfunction or weight gain; also used for smoking cessation" }
    ],
    pearls: [
      "SIG-E-CAPS mnemonic for MDD symptoms: Sleep, Interest (loss), Guilt, Energy (loss), Concentration, Appetite, Psychomotor changes, Suicidal ideation",
      "The greatest suicide risk occurs 2-4 weeks after starting antidepressants when energy improves before mood — monitor closely",
      "Black box warning: SSRIs may increase suicidal thinking in children, adolescents, and young adults under 25 — not a contraindication but requires close monitoring",
      "Atypical depression features (hypersomnia, hyperphagia, leaden paralysis, rejection sensitivity) may respond better to MAOIs or bupropion"
    ],
    quiz: [
      { question: "A patient started on sertraline 2 weeks ago for major depression reports feeling more energetic but still hopeless. Why should the nurse be particularly concerned?", options: ["The medication is not working and should be changed", "Increased energy without mood improvement increases suicide risk as the patient now has the motivation to act on suicidal thoughts", "The patient is likely abusing stimulants", "Serotonin syndrome is developing"], correct: 1, rationale: "During early antidepressant treatment, energy and motivation may improve before mood does. This paradoxically increases suicide risk because patients may now have the energy to act on existing suicidal ideation. Close monitoring during this period is critical." },
      { question: "Which statement about the PHQ-9 is correct?", options: ["A score of 5 indicates severe depression", "Item 9 screens specifically for suicidal ideation", "It is only valid for patients over 65 years", "A positive screen confirms the diagnosis of MDD"], correct: 1, rationale: "PHQ-9 item 9 specifically asks about thoughts of self-harm or suicidal ideation and is a critical screening component. A positive score of ≥10 suggests depression but is a screening tool, not diagnostic. Clinical interview is needed to confirm diagnosis." }
    ]
  },
  ...
  "generalized-anxiety-disorder": {
    ...
    cellular: {
      title: "Pathophysiology of Generalized Anxiety Disorder",
  ...
  "panic-disorder": {
    ...
    cellular: {
      title: "Pathophysiology of Panic Disorder",
      content: "Panic disorder is characterized by recurrent, unexpected panic attacks — sudden surges of intense fear or discomfort that peak within minutes and are accompanied by at least 4 of 13 defined symptoms. At least one attack must be followed by ≥1 month of persistent concern about additional attacks, worry about their consequences, or significant behavioral change.\n\nThe neurobiological model of panic disorder centers on the brain's fear network, primarily involving the amygdala, hippocampus, prefrontal cortex, periaqueductal gray, and brainstem nuclei (locus coeruleus and parabrachial nucleus). The amygdala serves as the alarm center, and in panic disorder, it has a lowered threshold for activation.\n\nDuring a panic attack, the amygdala activates the sympathetic nervous system, triggering a massive release of norepinephrine from the locus coeruleus and epinephrine from the adrenal medulla. This produces the characteristic fight-or-flight response: tachycardia, hyperventilation, sweating, trembling, chest tightness, and a sense of impending doom.\n\nHyperventilation during panic attacks causes respiratory alkalosis (decreased CO2, increased pH), which leads to cerebral vasoconstriction, paresthesias (tingling in extremities and face), dizziness, and lightheadedness. These symptoms are then misinterpreted as signs of a dangerous medical condition (heart attack, stroke), creating a positive feedback loop that intensifies the attack.\n\nThe suffocation alarm theory proposes that patients with panic disorder have a hypersensitive CO2 detector in the brainstem, which falsely triggers suffocation alarms even at normal CO2 levels. Cholecystokinin (CCK) and lactate infusions can provoke panic attacks in susceptible individuals, supporting a biological vulnerability."
    },
    riskFactors: [
      "Family history of panic disorder or anxiety disorders (heritability ~40%)",
      ...
      "Smoking (nicotine increases panic vulnerability)",
      "Comorbid depression or other anxiety disorders",
      "Substance use: caffeine, stimulants, cannabis, alcohol withdrawal",
      "Temperament: high anxiety sensitivity (fear of anxiety-related sensations)"
    ],
    diagnostics: [
      "DSM-5 criteria: recurrent unexpected panic attacks with ≥4 symptoms from 13 defined symptoms",
      "At least 1 month of persistent concern, worry about consequences, or behavioral change following an attack",
      "Rule out medical causes: cardiac evaluation (ECG, troponin), thyroid function, pheochromocytoma",
      "Panic Disorder Severity Scale (PDSS) for monitoring treatment response",
      "Assess for agoraphobia (avoidance of situations where escape might be difficult)"
    ],
    management: [
      "First-line: SSRIs (sertraline, paroxetine, fluoxetine) or SNRIs (venlafaxine)",
      "CBT with interoceptive exposure (deliberately inducing panic-like sensations to reduce fear)",
      "Short-term benzodiazepine PRN for severe attacks (clonazepam, alprazolam) while SSRI takes effect",
      "Breathing retraining to counteract hyperventilation",
      "Psychoeducation: panic attacks are not dangerous and cannot cause death, heart attack, or loss of control",
      "Gradual exposure to avoided situations if agoraphobia is present"
    ],
    nursingActions: [
      "During an acute panic attack: stay with the patient, speak calmly, guide slow breathing",
      "Coach controlled breathing: breathe in for 4 counts, hold for 4 counts, exhale for 6 counts",
      "Provide grounding techniques: 5-4-3-2-1 sensory grounding (5 things you see, 4 touch, 3 hear, 2 smell, 1 taste)",
      "Validate the patient's experience: 'I can see you are very frightened. You are safe. This will pass.'",
      "Educate that panic attacks typically peak within 10 minutes and resolve within 20-30 minutes",
      "Assess for development of agoraphobia and avoidance behaviors"
    ],
    signs: {
      left: [
    ...
    medications: [
      { name: "Paroxetine (Paxil)", type: "Selective Serotonin Reuptake Inhibitor (SSRI)", action: "Inhibits serotonin reuptake, restoring serotonergic balance in the fear circuitry; FDA-approved for panic disorder", sideEffects: "Weight gain, sexual dysfunction, sedation, dry mouth, discontinuation syndrome (worst among SSRIs)", contra: "Concurrent MAOI use, pregnancy (category D — highest teratogenicity risk among SSRIs)", pearl: "Has strongest anticholinergic effects among SSRIs; has the worst discontinuation syndrome — must taper very gradually" },
      { name: "Clonazepam (Klonopin)", type: "Benzodiazepine", action: "Enhances GABA-A receptor activity, rapidly reducing anxiety and panic through CNS inhibition", sideEffects: "Sedation, cognitive impairment, physical dependence, tolerance, respiratory depression with opioids/alcohol", contra: "Acute narrow-angle glaucoma, severe respiratory insufficiency, concurrent opioid use (FDA black box warning)", pearl: "Longer half-life provides more stable blood levels with less interdose rebound than alprazolam; used as bridge therapy during SSRI initiation" }
    ],
    pearls: [
      "Panic attacks peak within 10 minutes and typically resolve within 20-30 minutes — this is important patient education",
      "First-time panic attacks commonly present to the ED as suspected MI — rule out cardiac causes but also consider panic disorder",
      "Anxiety sensitivity (fear of anxiety symptoms themselves) is the strongest predictor of panic disorder development",
      "Agoraphobia complicates ~30-50% of panic disorder cases — early CBT with exposure prevents avoidance from becoming entrenched"
    ],
    quiz: [
      { question: "A patient experiencing a panic attack in the emergency department states 'I'm having a heart attack! I'm going to die!' Which nursing response is most therapeutic?", options: ["Don't worry, you're fine. It's just anxiety.", "I'm going to stay with you. You are safe. Let's breathe together slowly.", "I'll leave so you can calm down on your own.", "You need to stop overreacting — the tests show your heart is fine."], correct: 1, rationale: "Staying with the patient, providing reassurance of safety, and guiding breathing techniques are therapeutic interventions. Dismissing the experience ('just anxiety') or telling the patient to stop overreacting invalidates their very real distress and is non-therapeutic." },
      { question: "Which finding distinguishes panic disorder from a medical emergency such as myocardial infarction?", options: ["Presence of chest pain", "Symptoms peak within minutes and resolve within 20-30 minutes", "Elevated heart rate", "Patient reporting fear of dying"], correct: 1, rationale: "Panic attacks characteristically peak within 10 minutes and resolve within 20-30 minutes. While cardiac conditions must be ruled out (especially in first presentations), the temporal pattern of rapid onset and resolution helps distinguish panic from MI. However, medical causes should always be evaluated first." }
    ]
  },
  ...
  "obsessive-compulsive-disorder": {
    ...
    cellular: {
      title: "Pathophysiology of Obsessive-Compulsive Disorder",
  ...
  "therapeutic-communication-advanced": {
    ...
    cellular: {
      title: "Theory and Neuroscience of Therapeutic Communication",

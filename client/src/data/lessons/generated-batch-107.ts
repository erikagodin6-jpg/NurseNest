...
export const generatedBatch107Lessons: Record<string, LessonContent> = {
  "cardiogenic-shock": {
    ...
    cellular: {
      title: "Pathophysiology of Cardiogenic Shock",
      content: "Cardiogenic shock occurs when the heart is unable to pump sufficient blood to meet the metabolic demands of the body. The most common cause is extensive myocardial infarction involving 40% or more of the left ventricular myocardium. When a large area of myocardium becomes ischemic or necrotic, contractile force is dramatically reduced, leading to a precipitous drop in cardiac output and stroke volume.\n\nAt the cellular level, ischemic myocytes shift from aerobic to anaerobic metabolism, producing lactic acid and depleting ATP reserves. Without adequate ATP, the sodium-potassium pump fails, causing intracellular sodium and water accumulation (cellular edema) and extracellular potassium leakage. Calcium homeostasis is disrupted as sarcoplasmic reticulum function deteriorates, further impairing myocardial contractility. The cascade of cellular injury leads to myocyte death through both necrosis and apoptosis.\n\nThe failing ventricle triggers a series of compensatory mechanisms. The sympathetic nervous system is activated, releasing catecholamines that increase heart rate and systemic vascular resistance. The renin-angiotensin-aldosterone system (RAAS) is stimulated, promoting sodium and water retention to increase preload. While these mechanisms temporarily maintain blood pressure, they increase myocardial oxygen demand on an already failing heart, creating a vicious cycle of worsening ischemia and further contractile dysfunction. Elevated left ventricular end-diastolic pressure leads to pulmonary congestion and edema, further compromising oxygenation."
    },
    riskFactors: [
      "Acute ST-elevation myocardial infarction (STEMI) involving large territory",
      "Previous myocardial infarction with reduced ejection fraction",
      "Acute decompensated heart failure",
      "Severe valvular dysfunction (acute mitral regurgitation, aortic stenosis)",
      "Myocarditis or cardiomyopathy",
      "Ventricular septal rupture post-MI"
    ],
    diagnostics: [
      "Echocardiography showing reduced ejection fraction (<30%) and wall motion abnormalities",
      "Pulmonary artery catheter: elevated PCWP (>18 mmHg), reduced cardiac index (<2.2 L/min/m²)",
      "Serum lactate elevated indicating tissue hypoperfusion",
      "12-lead ECG showing ST changes, arrhythmias",
      "Chest X-ray revealing pulmonary edema, cardiomegaly",
      "Troponin I/T markedly elevated"
    ],
    management: [
      "Emergent percutaneous coronary intervention (PCI) for MI-related cardiogenic shock",
      "Inotropic support with dobutamine or milrinone to augment contractility",
      "Vasopressor therapy (norepinephrine) to maintain MAP >65 mmHg",
      "Intra-aortic balloon pump (IABP) or Impella device for mechanical circulatory support",
      "Diuretics cautiously if volume overloaded (avoid in hypovolemia)",
      "Consider extracorporeal membrane oxygenation (ECMO) for refractory shock"
    ],
    nursingActions: [
      "Continuous hemodynamic monitoring: arterial line, CVP, cardiac output",
      "Titrate vasopressors and inotropes per protocol to maintain target MAP",
      "Monitor urine output hourly (goal >0.5 mL/kg/hr)",
      "Assess for signs of end-organ perfusion: mental status, skin color, capillary refill",
      "Position patient to optimize hemodynamics (semi-Fowler's if tolerated)",
      "Monitor and trend serial lactate levels to assess treatment response"
    ],
    signs: {
      left: [
    ...
    medications: [
      { name: "Dobutamine", type: "Inotrope (beta-1 agonist)", action: "Increases myocardial contractility and cardiac output by stimulating beta-1 adrenergic receptors", sideEffects: "Tachycardia, hypotension, arrhythmias, increased myocardial oxygen demand", contra: "Hypertrophic obstructive cardiomyopathy, severe tachyarrhythmias", pearl: "Dobutamine may worsen hypotension due to beta-2 vasodilation; often paired with norepinephrine" },
      { name: "Norepinephrine", type: "Vasopressor (alpha-1 and beta-1 agonist)", action: "Increases SVR and MAP through potent alpha-1 vasoconstriction with some beta-1 inotropic effect", sideEffects: "Peripheral ischemia, arrhythmias, tissue necrosis with extravasation", contra: "Mesenteric or peripheral vascular thrombosis (relative)", pearl: "First-line vasopressor in cardiogenic shock; always administer via central line when possible" }
    ],
    pearls: [
      "Cardiogenic shock has a mortality rate of 40-50% even with aggressive treatment",
      "The key hemodynamic profile is LOW cardiac output, HIGH SVR, HIGH PCWP",
      "Do not volume load patients in cardiogenic shock without evidence of hypovolemia",
      "Early revascularization (PCI within 90 minutes) is the most important intervention for MI-related cardiogenic shock",
      "Lactate trending downward is the best indicator of improving tissue perfusion"
    ],
    quiz: [
      { question: "A patient in cardiogenic shock has the following hemodynamic values: CI 1.8 L/min/m², PCWP 24 mmHg, SVR 2200 dynes/sec/cm⁵. Which medication is the priority?", options: ["Dobutamine to increase cardiac output", "Aggressive IV normal saline bolus", "Nitroglycerin for preload reduction", "Furosemide 80 mg IV push"], correct: 0, rationale: "Dobutamine is the first-line inotrope to increase contractility and cardiac output. IV fluids would worsen pulmonary congestion (PCWP already high). Nitroglycerin and furosemide could worsen hypotension." },
      { question: "Which assessment finding best indicates improving tissue perfusion in a patient with cardiogenic shock?", options: ["Heart rate decreasing from 120 to 100 bpm", "Urine output increasing from 10 mL/hr to 45 mL/hr", "Blood pressure increasing from 82/60 to 88/62 mmHg", "Respiratory rate decreasing from 28 to 24 breaths/min"], correct: 1, rationale: "Urine output is the most reliable indicator of end-organ perfusion. A significant increase from 10 to 45 mL/hr indicates improved renal perfusion and cardiac output. Small changes in HR, BP, or RR are less reliable indicators." }
    ]
  },
  ...
  "obstructive-shock": {
    ...
    cellular: {
      title: "Pathophysiology of Obstructive Shock",
      content: "Obstructive shock results from mechanical obstruction to blood flow through the great vessels or the heart itself. Unlike cardiogenic shock where the myocardium fails intrinsically, obstructive shock occurs because an external force prevents adequate cardiac filling or ejection. The three classic causes are cardiac tamponade, tension pneumothorax, and massive pulmonary embolism.\n\nIn cardiac tamponade, fluid accumulates in the pericardial space (blood, effusion, or pus), compressing the cardiac chambers. The pericardium has limited compliance, and even moderate volumes of rapidly accumulating fluid (as little as 150-200 mL in acute settings) can critically impair diastolic filling. As intrapericardial pressure rises and approaches right atrial pressure, venous return collapses. The result is equalization of diastolic pressures across all chambers, dramatically reducing stroke volume and cardiac output.\n\nIn tension pneumothorax, air progressively accumulates in the pleural space under positive pressure, collapsing the ipsilateral lung and shifting the mediastinum toward the contralateral side. This mediastinal shift kinks the great veins (superior and inferior vena cava), reducing venous return to near zero. Simultaneously, the contralateral lung is compressed, worsening hypoxemia. In massive pulmonary embolism, a large clot obstructs the pulmonary vasculature, acutely increasing right ventricular afterload. The thin-walled right ventricle dilates and fails, reducing left ventricular preload through ventricular interdependence and septal bowing.\n\nAt the cellular level, the downstream effects mirror other forms of shock: inadequate tissue oxygen delivery leads to anaerobic metabolism, lactic acidosis, cellular ATP depletion, and ultimately multiorgan dysfunction if not rapidly corrected. The distinguishing feature is that the underlying pump (myocardium) is intrinsically normal and will recover once the obstruction is relieved."
    },
    riskFactors: [
      "Recent chest trauma (tension pneumothorax, tamponade)",
      "Pericarditis or post-cardiac surgery (tamponade)",
      "Deep vein thrombosis or prolonged immobility (massive PE)",
    ...
    diagnostics: [
      "Bedside echocardiography (POCUS) showing pericardial effusion, RV dilation, or IVC distension",
      "CT pulmonary angiography (CTPA) for suspected massive PE",
      "Chest X-ray: mediastinal shift (tension pneumothorax), widened cardiac silhouette (tamponade)",
      "Point-of-care ultrasound (E-FAST) in trauma settings",
      "ECG: electrical alternans (tamponade), right heart strain pattern S1Q3T3 (PE)",
      "Arterial blood gas showing acute respiratory acidosis and hypoxemia"
    ],
    management: [
      "Tension pneumothorax: immediate needle decompression (2nd intercostal space, midclavicular line) followed by chest tube",
      "Cardiac tamponade: emergent pericardiocentesis or surgical pericardial window",
      "Massive PE: systemic thrombolytics (alteplase), surgical embolectomy, or catheter-directed therapy",
      "IV fluid bolus to augment preload (temporary measure while definitive treatment prepared)",
      "Avoid positive-pressure ventilation if possible (further reduces venous return)",
      "Vasopressors as bridge therapy to maintain perfusion"
    ],
    nursingActions: [
      "Recognize Beck's triad (hypotension, JVD, muffled heart sounds) for tamponade",
      "Prepare pericardiocentesis tray and assist with bedside ultrasound-guided drainage",
      "For tension pneumothorax: have 14-gauge needle and chest tube insertion kit ready",
      "Monitor for pulsus paradoxus (>10 mmHg drop in SBP during inspiration)",
      "Maintain large-bore IV access and administer rapid crystalloid boluses as ordered",
    ...
    signs: {
      ...
      right: [
        ...
        "Cyanosis",
        "Distended neck veins with clear lung fields",
        "Electrical alternans on ECG (tamponade)"
      ]
    },
    medications: [
      { name: "Alteplase (tPA)", type: "Thrombolytic (tissue plasminogen activator)", action: "Converts plasminogen to plasmin to dissolve fibrin clots in pulmonary vasculature", sideEffects: "Major hemorrhage (intracranial, GI), bleeding at puncture sites, angioedema", contra: "Active internal bleeding, recent surgery (<3 weeks), hemorrhagic stroke, intracranial neoplasm", pearl: "In cardiac arrest from massive PE, alteplase 50 mg IV bolus can be given during CPR; continue CPR for at least 15 minutes after administration" },
      { name: "Heparin (unfractionated)", type: "Anticoagulant", action: "Potentiates antithrombin III to inhibit thrombin and factor Xa, preventing clot propagation", sideEffects: "Hemorrhage, heparin-induced thrombocytopenia (HIT), osteoporosis with long-term use", contra: "Active uncontrolled bleeding, severe thrombocytopenia, HIT history", pearl: "In massive PE, give heparin bolus 80 units/kg IV followed by 18 units/kg/hr infusion; do not delay anticoagulation waiting for imaging if clinical suspicion is high" }
    ],
    pearls: [
      "Obstructive shock is the most treatable form of shock IF recognized early - removal of obstruction is curative",
      "Beck's triad (hypotension, JVD, muffled heart sounds) is present in only 10-40% of tamponade cases",
      "Tension pneumothorax is a CLINICAL diagnosis - do NOT delay treatment for chest X-ray",
      "In massive PE, the right ventricle fails from acute pressure overload, not volume overload",
      "Key differentiator from cardiogenic shock: in obstructive shock, the myocardium is intrinsically normal"
    ],
    quiz: [
      { question: "A trauma patient develops sudden hypotension, absent breath sounds on the left, tracheal deviation to the right, and JVD. What is the priority nursing action?", options: ["Obtain a stat chest X-ray", "Prepare for needle decompression at the 2nd intercostal space, left midclavicular line", "Start a norepinephrine infusion", "Place the patient on 100% non-rebreather mask"], correct: 1, rationale: "Tension pneumothorax is a clinical diagnosis requiring immediate needle decompression. Delaying for imaging can be fatal. Vasopressors and oxygen are supportive but do not address the underlying obstruction." },
      { question: "A patient with a large pericardial effusion develops Beck's triad. Which hemodynamic finding is expected?", options: ["Decreased CVP with decreased PCWP", "Equalization of diastolic pressures across all chambers", "Markedly elevated SVR with low cardiac output", "Decreased right atrial pressure with increased left atrial pressure"], correct: 1, rationale: "In cardiac tamponade, external compression by pericardial fluid causes equalization of diastolic pressures (RA, RV diastolic, PA diastolic, and PCWP all converge). This is the hallmark hemodynamic finding." }
    ]
  },
  ...
  "acute-deterioration-recognition": {
    ...
    cellular: {
      title: "Pathophysiology of Acute Clinical Deterioration",
      content: "Acute clinical deterioration is the progression from physiological stability to organ dysfunction and potential cardiopulmonary arrest. Research consistently demonstrates that patients exhibit warning signs 6-8 hours before cardiac arrest, and that recognition and intervention during this window dramatically improves survival. Understanding the physiological cascade of deterioration enables nurses to identify subtle early changes before overt decompensation occurs.\n\nThe body's response to acute illness follows a predictable pattern of compensatory mechanisms. When oxygen delivery to tissues becomes inadequate (from any cause: sepsis, hemorrhage, cardiac failure, respiratory failure), chemoreceptors and baroreceptors trigger compensatory responses. The sympathetic nervous system releases catecholamines, producing tachycardia (to increase cardiac output), peripheral vasoconstriction (to maintain blood pressure), and tachypnea (to increase oxygen intake and CO2 elimination). These compensatory vital sign changes are often the FIRST detectable signs of deterioration.\n\nAs the underlying process worsens and compensatory reserves are exhausted, decompensation begins. Blood pressure falls as the cardiovascular system can no longer maintain perfusion through tachycardia and vasoconstriction alone. Tissue hypoperfusion worsens, causing cellular metabolic failure. The brain, the most oxygen-sensitive organ, manifests hypoperfusion through altered mental status - initially subtle (restlessness, anxiety, confusion) and progressing to obtundation and unresponsiveness.\n\nThe concept of 'failure to rescue' describes the inability of healthcare providers to recognize and respond to deteriorating patients in time to prevent death. Studies show that the most common failures are: not measuring vital signs frequently enough, not recognizing the significance of abnormal values, not communicating concerns effectively to the medical team, and not escalating care when initial interventions fail. Early Warning Score systems (NEWS, MEWS) were developed to systematize the detection of deterioration by aggregating multiple physiological parameters into a single composite score that triggers escalation protocols."
    },
    riskFactors: [
      "Recent ICU discharge to general ward (within 48 hours)",
      "New onset of organ dysfunction (acute kidney injury, liver failure)",
      "Uncontrolled sepsis or systemic inflammatory response",
      "Acute cardiac events (MI, arrhythmia, heart failure exacerbation)",
      "Post-operative complications (hemorrhage, anastomotic leak)",
      "Respiratory compromise (new oxygen requirement, increasing work of breathing)",
      "Opioid or sedative administration (respiratory depression risk)"
    ],
    diagnostics: [
      "National Early Warning Score 2 (NEWS2) calculated at every vital sign assessment",
      "Point-of-care lactate for tissue perfusion assessment",
      "Arterial blood gas for acid-base and oxygenation status",
      "Comprehensive metabolic panel: electrolytes, renal function, liver function",
      "12-lead ECG for suspected cardiac etiology",
      "Chest X-ray for respiratory deterioration assessment",
      "Blood cultures if infection suspected"
    ],
    management: [
      "Implement graded response based on Early Warning Score: increased monitoring frequency → bedside clinician review → RRT activation → code team",
      "Address reversible causes using the 'H's and T's' framework: Hypovolemia, Hypoxia, Hydrogen ion (acidosis), Hypo/hyperkalemia, Hypothermia, Tension pneumothorax, Tamponade, Toxins, Thrombosis (PE/MI)",
      "Escalate care proactively: request ICU consultation BEFORE arrest occurs",
      "Ensure code cart and emergency equipment are at bedside for high-risk patients",
      "Implement continuous telemetry and frequent vital sign monitoring (every 15-30 minutes if deteriorating)",
      "Optimize fluid status, oxygenation, and perfusion as bridge interventions"
    ],
    nursingActions: [
      "Calculate and document NEWS2 score with EVERY vital sign assessment",
      "Trend vital signs over time - a single normal value does not rule out deterioration",
      "Assess mental status using standardized tools (GCS, AVPU) with each assessment",
      "Trust clinical intuition: 'something doesn't feel right' is a valid concern requiring investigation",
      "Communicate concerns using SBAR and escalate if response is inadequate (chain of command)",
      "Perform bedside handoff with visualization of the patient to identify changes between shifts"
    ],
    signs: {
      left: [
        "Rising heart rate (compensatory tachycardia is often the FIRST sign)",
        "Rising respiratory rate (>20 precedes many deterioration events)",
        "Falling blood pressure (LATE sign - indicates decompensation)",
        "Falling oxygen saturation despite increasing supplemental oxygen"
      ],
      right: [
        "New confusion, agitation, or decreased responsiveness",
        "Decreasing urine output (<0.5 mL/kg/hr for >2 hours)",
        "New or worsening pain",
        "Patient or family expressing concern about the patient's condition",
        "Mottled or cyanotic skin appearance",
        "Increasing lactate levels on serial measurements"
      ]
    },
    medications: [
      { name: "Epinephrine", type: "Catecholamine (non-selective adrenergic agonist)", action: "Alpha-1 vasoconstriction maintains coronary and cerebral perfusion; beta-1 increases HR and contractility; first-line in cardiac arrest and anaphylaxis", sideEffects: "Tachyarrhythmias, hypertensive crisis, myocardial ischemia, anxiety, tremor", contra: "No absolute contraindications in cardiac arrest or anaphylaxis", pearl: "Cardiac arrest: 1 mg IV/IO (1:10,000) every 3-5 minutes. Anaphylaxis: 0.3-0.5 mg IM (1:1,000) in anterolateral thigh. NEVER confuse concentrations" },
      { name: "Naloxone", type: "Opioid receptor antagonist", action: "Competitively displaces opioids from mu, kappa, and delta receptors, reversing respiratory depression, sedation, and hypotension", sideEffects: "Acute opioid withdrawal syndrome (agitation, nausea, vomiting, tachycardia, diaphoresis), pulmonary edema (rare)", contra: "Known hypersensitivity; use with caution in chronic opioid-dependent patients", pearl: "Start with 0.04-0.4 mg IV and titrate to respiratory rate >12; goal is to reverse respiratory depression WITHOUT reversing all analgesia; duration is 30-90 minutes so repeat dosing or infusion may be needed" }
    ],
    pearls: [
      "Tachycardia and tachypnea are the EARLIEST compensatory signs of deterioration - never dismiss them",
      "Hypotension is a LATE sign of shock - by the time BP drops, the patient has already lost significant compensatory reserve",
      "The respiratory rate is the single most predictive vital sign for clinical deterioration and in-hospital mortality",
      "NEWS2 score ≥5 (or any single parameter scoring 3) should trigger urgent clinical review",
      "Failure to rescue is most often caused by failure to RECOGNIZE and COMMUNICATE, not failure to treat",
      "Always reassess within 15-30 minutes after any intervention to determine if the patient is improving or continuing to decline"
    ],
    quiz: [
      { question: "A nurse assesses a patient and finds: HR 108 (was 78 two hours ago), RR 24 (was 16), BP 118/72 (unchanged), SpO2 95% (was 98%). The patient appears more anxious. What is the most appropriate action?", options: ["Document findings and reassess in 4 hours", "Increase vital sign monitoring to every 1-2 hours and perform focused assessment", "Activate the Rapid Response Team immediately", "Administer anxiolytic medication for patient comfort"], correct: 1, rationale: "These findings show early compensatory changes (rising HR and RR, mild SpO2 drop, new anxiety) without overt decompensation. BP is maintained, indicating compensation is intact. The nurse should increase monitoring frequency, perform a focused assessment to identify the cause, and notify the provider. This is not yet RRT territory but requires heightened surveillance." },
      { question: "Which vital sign change is the EARLIEST indicator of clinical deterioration?", options: ["Hypotension (systolic BP <90 mmHg)", "Increasing respiratory rate", "Decreasing oxygen saturation below 90%", "Decreasing level of consciousness"], correct: 1, rationale: "Respiratory rate is consistently the earliest and most sensitive predictor of clinical deterioration. Tachypnea often precedes changes in heart rate, blood pressure, and oxygen saturation by hours. Hypotension and decreased consciousness are LATE signs indicating decompensation." }
    ]
  }
};

...
export const clinicalScenariosLessons: Record<string, LessonContent> = {
  ...
  "delegation-traps-exam": {
    ...
    medications: [
      {
        ...
        pearl: "Even when an LPN administers medications, the RN is responsible for evaluating the therapeutic and adverse effects. The RN must follow up on the patient's response."
      }
    ],
    pearls: [
    ...
    preTest: [
      {
        question: "Which task can the RN delegate to the UAP?",
        options: [
      ...
      },
      {
        ...
        options: [
          "Delegation transfers accountability from the RN to the delegate",
          "The most experienced UAP can perform assessments",
          "The RN remains accountable for outcomes of delegated tasks",
          "LPNs can independently create nursing care plans"
        ],
        correct: 2,
        rationale: "Delegation NEVER transfers accountability. The RN remains accountable for the decision to delegate, the appropriateness of the delegation, and the patient outcomes. Experience does not change scope, and care planning is an RN-only function."
      }
    ],
    postTest: [
      {
      ...
      },
      {
        ...
        correct: 1,
        rationale: "When a delegated task reveals a change in patient status, the LPN must report to the RN for reassessment. The RN evaluates the wound, modifies the care plan as needed, and communicates with the provider. The LPN identified a significant change that requires RN assessment and clinical judgment."
      },
      {
  ...
  "acute-deterioration-recognition": {
    title: "Acute Deterioration Recognition & Rapid Response",
    cellular: {
      title: "Pathophysiology of Clinical Deterioration and Failure-to-Rescue",

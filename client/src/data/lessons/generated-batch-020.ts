...
export const generatedBatch020Lessons: Record<string, LessonContent> = {
  "cirrhosis-core-np": {
    title: "Cirrhosis",
    cellular: { title: "Pathophysiology of Cirrhosis", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "cirrhosis-diagnostic-criteria-np": {
    ...
    cellular: { title: "Pathophysiology of Cirrhosis: Imaging, Labs & Clinical Findings", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "cirrhosis-management-np": {
    ...
    cellular: { title: "Pathophysiology of Cirrhosis Management", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "cirrhosis-patho-np": {
    ...
    cellular: { title: "Pathophysiology of Cirrhosis: Portal Hypertension & Ascites Formation", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "ckd-diagnostic-criteria-np": {
    ...
    cellular: { title: "Pathophysiology of Ckd Diagnostic Criteria", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "ckd-medication-adjustments-np": {
    ...
    cellular: { title: "Pathophysiology of CKD Medication Adjustments", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "ckd-progression-patho-np": {
    ...
    cellular: { title: "Pathophysiology of CKD Progression: Nephron Loss & RAAS Overactivation", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "ckd-staging-np": {
    ...
    cellular: { title: "Pathophysiology of CKD: KDIGO Staging & Progression Management", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "clinical-reasoning-np": {
    ...
    cellular: { title: "Pathophysiology of Clinical Reasoning and Decision-Making", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "cml-management-np": {
    ...
    cellular: { title: "Pathophysiology of CML: BCR-ABL & Tyrosine Kinase Inhibitors", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
  ...
  "cmp-interpretation-np": {
    ...
    cellular: { title: "Pathophysiology of CMP Interpretation", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },

...
export const generatedBatch046Lessons: Record<string, LessonContent> = {
  ...
  "hiv-basics-rpn": {
    ...
    cellular: { title: "Pathophysiology of HIV Infection", content: "Human immunodeficiency virus (HIV) is a retrovirus that specifically targets and destroys CD4+ T-helper lymphocytes, which are the central coordinators of the adaptive immune system. Without these cells, the body becomes progressively unable to mount effective immune responses, eventually leading to acquired immunodeficiency syndrome (AIDS) — defined as a CD4 count below 200 cells/microlitre or the presence of an AIDS-defining opportunistic infection.\n\nHIV exists as two types: HIV-1 (responsible for >95% of infections worldwide) and HIV-2 (less virulent, primarily in West Africa). The virus is transmitted through three main routes: sexual contact (most common globally), percutaneous exposure to infected blood (needlestick injuries, injection drug use with shared equipment), and vertical (mother-to-child) transmission during pregnancy, delivery, or breastfeeding.\n\nThe viral lifecycle begins with HIV binding to the CD4 receptor and a co-receptor (CCR5 or CXCR4) on the target cell surface. Reverse transcriptase converts viral RNA into double-stranded DNA. Integrase incorporates it into the host genome (provirus). The integrated provirus uses host cell machinery to produce new viral RNA and proteins. Protease cleaves viral polyproteins into functional components, and new viral particles assemble and bud from the cell surface.\n\nThe natural history of untreated HIV progresses through three stages: acute HIV infection (2-4 weeks after exposure) with acute retroviral syndrome (fever, lymphadenopathy, pharyngitis, rash); clinical latency (8-10 years, asymptomatic, gradual CD4 decline); and AIDS (CD4 <200 or AIDS-defining conditions including PCP, toxoplasmosis, cryptococcal meningitis, Kaposi sarcoma). ART has transformed HIV from a fatal disease to a manageable chronic condition. The U=U principle (Undetectable = Untransmittable) means patients with sustained undetectable viral loads do not transmit HIV sexually." },
    signs: { left: ["Acute retroviral syndrome: fever, pharyngitis, rash, lymphadenopathy", "Persistent generalized lymphadenopathy", "Oral thrush (white plaques, CD4 <300)", "Weight loss and chronic diarrhea", "Night sweats and recurrent fevers"], right: ["PCP: dry cough, dyspnea, hypoxia (CD4 <200)", "Kaposi sarcoma: violaceous skin lesions (HHV-8)", "Cryptococcal meningitis: headache, neck stiffness (CD4 <100)", "Oral hairy leukoplakia: white corrugated lesions on lateral tongue", "Wasting syndrome: >10% weight loss with chronic diarrhea"] },
    medications: [{ name: "Tenofovir/Emtricitabine (Truvada)", type: "NRTI Combination (also used for PrEP)", action: "Both are nucleos(t)ide reverse transcriptase inhibitors that cause HIV DNA chain termination by competing with natural nucleotides during reverse transcription", sideEffects: "Nausea, headache, renal toxicity (TDF), decreased bone mineral density (TDF), lactic acidosis (rare)", contra: "CrCl <30 mL/min (TDF formulation), untreated hepatitis B (HBV flare risk upon discontinuation)", pearl: "Used as dual-NRTI backbone in many ART regimens; also approved as daily PrEP for HIV-negative individuals at high risk (>99% effective); must check HBV status before starting" }],
    pearls: ["CD4 count determines OI risk: <200 = PCP (start TMP-SMX); <100 = toxo, crypto; <50 = MAC (start azithromycin), CMV", "U=U (Undetectable = Untransmittable): sustained undetectable viral load eliminates sexual HIV transmission", "Standard precautions (not isolation) are appropriate for HIV patients — the virus is not transmitted by casual contact", "PEP must be started within 72 hours (ideally ≤2 hours) of exposure and continued for 28 days", "ART adherence >95% is required to maintain viral suppression"],
    quiz: [{ question: "A healthcare worker sustains a needlestick injury from an HIV-positive patient. It has been 4 hours. What is the priority action?", options: ["Wait for baseline HIV test results before starting medication", "Initiate PEP with a 3-drug ART regimen immediately", "Reassure that needlestick injuries never transmit HIV", "Start PrEP and continue indefinitely"], correct: 1, rationale: "PEP should be initiated as soon as possible, ideally within 2 hours and no later than 72 hours. A 3-drug ART regimen is taken for 28 days. Baseline testing should NEVER delay PEP initiation." }, { question: "A patient with HIV has a CD4 count of 180. Which prophylactic medication should be prescribed?", options: ["Azithromycin for MAC prophylaxis", "Fluconazole for fungal prophylaxis", "TMP-SMX for Pneumocystis (PCP) prophylaxis", "Acyclovir for herpes prophylaxis"], correct: 2, rationale: "PCP prophylaxis with TMP-SMX is indicated when CD4 <200. PCP is the most common AIDS-defining OI. MAC prophylaxis starts at CD4 <50." }, { question: "A patient on ART has maintained an undetectable viral load for 8 months. Their partner asks about condom use. What information should the nurse provide?", options: ["Condoms must always be used regardless of viral load", "U=U means sustained undetectable viral load eliminates sexual transmission risk, though condoms still protect against other STIs", "Viral load must be undetectable for 5 years first", "Only female condoms can be discontinued"], correct: 1, rationale: "The U=U principle is supported by landmark studies showing zero linked HIV transmissions from partners with sustained undetectable viral loads. Condoms continue to protect against other STIs." }]
  },
  ...
  "home-care-nursing-rpn": {
    ...
    cellular: { title: "Home Care Nursing Practice", content: "Home care nursing involves providing skilled nursing care in the patient's home environment, requiring adaptation of clinical skills to uncontrolled settings. The nurse functions with greater autonomy than in institutional settings, performing comprehensive assessments, implementing care plans, administering medications and treatments, managing wounds, providing patient and caregiver education, and coordinating with the interprofessional team. Key principles include: bag technique (placing the nursing bag on a clean barrier, removing only needed supplies, closing the bag before patient care to prevent cross-contamination between patients), environmental assessment (safety hazards, infection control challenges, medication storage, emergency access), and establishing therapeutic relationships with patients and families in their personal space. The nurse must assess for signs of elder abuse or neglect (unexplained injuries, malnutrition, fearfulness, poor hygiene), manage chronic conditions, and facilitate transitions between hospital and home. Documentation must reflect skilled nursing necessity for continued home care authorization." },
    signs: { left: ["Wound healing progress or deterioration", "Vital sign trends at home", "Medication compliance indicators (pill counts, refills)", "Nutritional status and weight changes", "Caregiver capability and coping"], right: ["Signs of elder abuse: unexplained injuries, fearfulness, malnutrition", "Environmental hazards: fall risks, fire safety", "Infection indicators: fever, wound changes", "Caregiver burnout: exhaustion, depression", "Decline in functional status"] },
    medications: [{ name: "Insulin (Self-Administration Education)", type: "Hormone — Blood Glucose Regulation", action: "Facilitates cellular glucose uptake, suppresses hepatic gluconeogenesis, and promotes glycogen storage", sideEffects: "Hypoglycemia, weight gain, injection site lipohypertrophy, allergic reactions (rare)", contra: "Hypoglycemia", pearl: "Teach injection technique, site rotation, sharps disposal in puncture-resistant containers, hypoglycemia recognition (15-15 rule), and proper storage (refrigerated until opened, room temp 28 days)" }],
    pearls: ["Bag technique prevents cross-contamination: place bag on clean barrier, remove only needed items, close before patient care", "Mandatory reporting: nurses must report suspected abuse/neglect — report to appropriate authorities", "Environmental assessment is unique to home care: evaluate fall risks, fire safety, medication storage", "Sharps disposal: puncture-resistant containers (commercial sharps containers or rigid plastic bottles)", "Documentation must demonstrate skilled nursing necessity for continued home care services"],
    quiz: [{ question: "Which action demonstrates proper bag technique?", options: ["Place bag on patient's kitchen table and open fully", "Place bag on clean barrier, remove only needed supplies, close before starting care", "Keep bag open throughout visit", "Place bag on floor near patient's bed"], correct: 1, rationale: "Proper bag technique: clean barrier, remove only needed supplies, close bag before patient care — prevents cross-contamination." }, { question: "A nurse notices multiple bruises in healing stages, patient fearfulness around caregiver, and 10-lb weight loss. Priority action?", options: ["Document and reassess next visit", "Confront the caregiver", "Report suspected elder abuse to authorities (mandatory reporting)", "Suggest increased caloric intake"], correct: 2, rationale: "Unexplained bruises, fearfulness, and weight loss are concerning for elder abuse. The nurse is a mandatory reporter and must report to appropriate authorities." }, { question: "How should a home care patient dispose of used insulin needles?", options: ["Regular garbage bag", "Puncture-resistant container such as a sharps container or rigid plastic bottle", "Empty glass jar with lid", "Paper bag labeled biohazardous"], correct: 1, rationale: "Sharps must be in puncture-resistant containers. Commercial sharps containers or rigid plastic containers with screw-top lids are acceptable." }]
  },
  "hormonal-regulation": {
    title: "Mechanisms of Hormonal Regulation",
    cellular: { title: "Endocrine Feedback Mechanisms", content: "The endocrine system regulates physiological processes through hormones — chemical messengers synthesized by endocrine glands and transported via the bloodstream to target tissues. Hormonal regulation operates through feedback loops: negative feedback (predominant) maintains homeostasis by suppressing hormone production when levels are adequate; positive feedback (rare) amplifies a response until a physiological endpoint (oxytocin during labor, LH surge triggering ovulation). The hypothalamic-pituitary axis is the master regulatory system. The hypothalamus secretes releasing and inhibiting hormones that travel via the hypothalamic-hypophyseal portal system to the anterior pituitary, which produces tropic hormones that stimulate target glands. Example: TRH → TSH → T3/T4 → negative feedback suppresses TRH and TSH. In primary gland failure (e.g., primary hypothyroidism), target hormone is LOW and tropic hormone is HIGH (loss of negative feedback). In secondary/central failure (pituitary damage), BOTH are LOW. Hormones are classified by solubility: water-soluble (peptides, catecholamines) bind cell-surface receptors using second messengers (cAMP); lipid-soluble (steroids, thyroid hormones) cross cell membranes and bind nuclear receptors, modifying gene expression. Cortisol follows a diurnal rhythm: highest in early morning, lowest at midnight — disrupted in Cushing syndrome." },
    signs: { left: ["Primary hypothyroidism: HIGH TSH, LOW T4 (gland failure)", "Primary hyperthyroidism: LOW TSH, HIGH T4 (gland overproduction)", "Primary adrenal insufficiency: LOW cortisol, HIGH ACTH", "Cushing syndrome: elevated cortisol, loss of diurnal rhythm", "Diabetes insipidus: low ADH, dilute polyuria, hypernatremia"], right: ["Secondary hypothyroidism: LOW TSH, LOW T4 (pituitary failure)", "SIADH: excess ADH, concentrated urine, dilutional hyponatremia", "Pheochromocytoma: excess catecholamines (episodic HTN, palpitations, diaphoresis)", "Acromegaly: excess GH (enlarged hands/feet, coarsened features)", "Primary hyperaldosteronism: HTN + hypokalemia + metabolic alkalosis"] },
    medications: [{ name: "Levothyroxine (Synthroid)", type: "Synthetic Thyroid Hormone (T4)", action: "Replaces deficient thyroid hormone; T4 is converted to active T3 peripherally. Restores normal metabolic rate", sideEffects: "Tachycardia, palpitations, tremor, weight loss, heat intolerance (over-replacement signs); bone loss with chronic over-replacement", contra: "Untreated adrenal insufficiency (must replace cortisol first), uncorrected thyrotoxicosis, acute MI (relative)", pearl: "Take on empty stomach 30-60 min before breakfast; separate from calcium, iron, antacids by 4 hours; monitor TSH 6-8 weeks after dose changes; CRITICAL: ensure adequate cortisol replacement BEFORE starting in patients with adrenal insufficiency" }],
    pearls: ["Primary gland failure = LOW target hormone + HIGH tropic hormone; secondary = LOW both", "Levothyroxine: empty stomach 30-60 min before food; separate from calcium/iron/antacids by 4 hours", "NEVER start levothyroxine in untreated adrenal insufficiency — precipitates adrenal crisis", "Cortisol circadian rhythm: highest 8 AM, lowest midnight — loss suggests Cushing syndrome", "TSH is the best screening test for thyroid disorders: elevated = hypothyroid, suppressed = hyperthyroid"],
    quiz: [{ question: "A patient with Addison disease is being started on levothyroxine for hypothyroidism. What is MOST important before initiating?", options: ["Baseline ECG", "Ensure adequate cortisol replacement is stable before starting levothyroxine", "Schedule follow-up TSH in 2 weeks", "Take levothyroxine with food"], correct: 1, rationale: "Thyroid hormones increase cortisol metabolism. In adrenal insufficiency, starting levothyroxine without adequate cortisol replacement can precipitate adrenal crisis." }, { question: "Lab results show TSH 0.1, Free T4 3.8, Free T3 8.2. Which condition?", options: ["Primary hypothyroidism", "Secondary hypothyroidism", "Hyperthyroidism (primary)", "TSH-secreting pituitary adenoma"], correct: 2, rationale: "Low TSH with elevated T4 and T3 = primary hyperthyroidism. The thyroid is overproducing hormones, and negative feedback suppresses TSH." }, { question: "When should cortisol be drawn to evaluate for Cushing syndrome?", options: ["Early morning (8 AM)", "Late evening (11 PM-midnight)", "After breakfast", "Any time of day"], correct: 1, rationale: "Late-evening/midnight cortisol is most useful for Cushing syndrome because cortisol should normally be at its nadir. In Cushing syndrome, the diurnal variation is lost." }]
  },
  ...
  "hospice-eligibility-np": {
    ...
    cellular: { title: "Hospice Eligibility Determination", content: "Hospice care is covered under the Medicare Hospice Benefit when two physicians certify a terminal illness with life expectancy of 6 months or less. Local Coverage Determinations (LCDs) provide disease-specific criteria. General indicators: declining functional status (PPS <50%, Karnofsky <50), progressive weight loss >10% over 6 months, declining albumin <2.5 g/dL, recurrent infections, progressive dysphagia, repeated hospitalizations. Disease-specific LCD criteria: Heart disease — NYHA Class IV despite GDMT, LVEF ≤20%, refractory arrhythmias; Pulmonary disease — FEV₁ <30% predicted, O₂ dependent at rest, cor pulmonale; Cancer — extensive metastases, declining function, declining further disease-directed therapy; Dementia — FAST ≥7 (unable to ambulate, dress, bathe; ≤6 words/day) plus comorbidity (aspiration pneumonia, septicemia, pressure ulcers); Renal disease — not pursuing dialysis with CrCl <15. The NP plays a critical role in identifying hospice-appropriate patients, conducting goals-of-care conversations, certifying terminal illness, and managing complex symptom regimens. The surprise question ('Would you be surprised if this patient died within 6 months?') is a simple but effective screening tool." },
    riskFactors: ["Terminal illness with prognosis ≤6 months", "Declining functional status (PPS <50%)", "Progressive weight loss >10% over 6 months", "Frequent hospitalizations despite optimal management", "Patient/family desire for comfort-focused care", "Recurrent infections or progressive dysphagia"],
    diagnostics: ["Palliative Performance Scale or Karnofsky Scale assessment", "FAST Scale staging for dementia (≥7 with comorbidity = hospice eligible)", "Serum albumin <2.5 g/dL (poor prognosis marker)", "Disease-specific assessments: LVEF, FEV₁, tumor staging, CrCl", "Hospitalization frequency (≥3 in 6 months suggests declining trajectory)", "Surprise question screening tool"],
    management: ["Two-physician certification of terminal illness", "Transition to comfort-focused care", "Comprehensive symptom management: pain (WHO ladder, opioids), dyspnea, nausea, delirium, terminal secretions", "Four components: physical, emotional, social, and spiritual support", "Bereavement support for 13 months after death", "Patient can revoke hospice and return to curative treatment at any time"],
    nursingActions: ["Identify hospice-eligible patients using surprise question and LCD criteria", "Initiate goals-of-care conversations", "Complete certification documentation", "Manage complex symptom regimens", "Educate family on disease trajectory and when to call hospice vs 911", "Support family decision-making without imposing personal values"],
    assessmentFindings: ["Declining PPS score", "Increased sleep and decreased oral intake", "Peripheral cyanosis and mottling", "Cheyne-Stokes respirations and terminal apnea", "Terminal secretions (death rattle)", "Decreased urine output progressing to anuria"],
    signs: {
      left: ["PPS <50%", "Weight loss >10% over 6 months", "Albumin <2.5 g/dL", "Recurrent hospitalizations", "Progressive dysphagia"],
      right: ["Active dying: mottling, Cheyne-Stokes, mandibular breathing", "Terminal restlessness and delirium", "Death rattle (terminal secretions)", "Anuria (approaching death)", "Pain and dyspnea at end of life"]
    },
    medications: [{
      name: "Morphine",
      type: "Opioid Analgesic (Mu-Receptor Agonist)",
      action: "Binds mu-opioid receptors providing potent analgesia and dyspnea relief. Reduces perception of pain and air hunger",
      sideEffects: "Constipation (tolerance does NOT develop), sedation, nausea, respiratory depression (rare at appropriate doses), urinary retention",
      contra: "In hospice, comfort takes priority over conventional contraindications; severe respiratory depression is rare at appropriate doses",
      pearl: "Breakthrough dose = 10-15% of total daily dose; constipation prophylaxis MANDATORY; tolerance develops to sedation and nausea but NOT constipation; morphine also treats dyspnea at lower doses than for pain"
    }],
    pearls: ["Surprise question ('Would you be surprised if this patient died in 6 months?') is a screening tool for hospice referral", "Hospice ≠ giving up — it is choosing comfort-focused expert care", "Constipation is the ONE opioid side effect with NO tolerance — always prescribe prophylactic bowel regimen", "Low-dose morphine treats DYSPNEA in addition to pain", "Hospice patients can REVOKE the election and return to curative treatment at any time", "Terminal secretions are more distressing to FAMILIES than to the patient"],
    quiz: [
      {
        question: "A patient with advanced HF has NYHA IV despite GDMT, LVEF 18%, and three hospitalizations in 6 months. What should the NP consider?",
        options: ["Add another HF medication", "Heart transplant referral", "Discuss hospice eligibility — patient meets LCD cardiac criteria", "Continue current management"],
        correct: 2,
        rationale: "This patient meets LCD criteria for hospice with cardiac disease: NYHA IV despite GDMT, LVEF ≤20%, recurrent hospitalizations."
      },
      {
        question: "Which FAST Scale stage with comorbidity indicates hospice eligibility for dementia?",
        options: ["FAST 5", "FAST 6", "FAST 7 or higher plus comorbidity (aspiration pneumonia, septicemia, pressure ulcers)", "Any FAST stage"],
        correct: 2,
        rationale: "Dementia hospice eligibility requires FAST ≥7 (unable to ambulate, dress, bathe; ≤6 words/day) PLUS a comorbidity within past 12 months."
      },
      {
        question: "A hospice patient on morphine hasn't had a bowel movement in 3 days. What should have been prescribed at opioid initiation?",
        options: ["Anti-diarrheal", "Prophylactic bowel regimen — constipation tolerance never develops with opioids", "Nothing — constipation resolves on its own", "Fiber supplements only"],
        correct: 1,
        rationale: "Constipation is the only opioid side effect without tolerance development. Prophylactic bowel regimen (senna ± docusate) should start simultaneously with opioid therapy."
      },
    ]
  },
  "hospice-vs-palliative-rpn": {
    title: "Hospice Care Versus Palliative Care",
    cellular: { title: "Hospice vs Palliative Care", content: "Palliative care and hospice care both focus on improving quality of life for patients with serious illness, but differ in timing, eligibility, and approach. Palliative care can be initiated at any point during serious illness regardless of prognosis and can be provided concurrently with curative treatments. It addresses symptom management (pain, dyspnea, nausea, fatigue), psychosocial support, care coordination, and goals-of-care discussions. Hospice care is a specialized form of palliative care for patients with a terminal prognosis of 6 months or less who have chosen comfort over cure. Under the Medicare Hospice Benefit, patients receive comprehensive comfort care including nursing visits, medications, equipment, spiritual care, and 13 months of bereavement support. Patients can revoke hospice at any time. The practical nurse focuses on symptom assessment, medication administration (especially opioids), family education on disease trajectory, emotional support, and recognizing active dying (changes in breathing, decreased consciousness, mottling, decreased urine output)." },
    signs: { left: ["Declining functional status (increased sleep, decreased activity)", "Progressive weight loss and decreased oral intake", "Increasing symptom burden requiring medication adjustment", "Social withdrawal and decreased communication", "Caregiver burden and fatigue"], right: ["Active dying: mottling, Cheyne-Stokes, mandibular breathing", "Terminal secretions (death rattle)", "Decreased urine output progressing to anuria", "Peripheral cyanosis and cool extremities", "Terminal restlessness or delirium"] },
    medications: [{ name: "Morphine (Hospice/Palliative Use)", type: "Opioid Analgesic", action: "Binds mu-opioid receptors providing analgesia and dyspnea relief at end of life", sideEffects: "Constipation (tolerance never develops), sedation, nausea, respiratory depression (rare at comfort doses)", contra: "In hospice, comfort is the primary goal — no absolute contraindications when used for comfort", pearl: "Start low, titrate to comfort; breakthrough = 10-15% of total daily dose; constipation prophylaxis MANDATORY; RR of 10 with comfortable patient is acceptable; morphine treats dyspnea at lower doses than pain" }],
    pearls: ["Palliative care = any stage, concurrent with curative treatment; Hospice = terminal ≤6 months, comfort-focused", "Patients can REVOKE hospice at any time and return to curative treatment", "Terminal secretions are more distressing to FAMILIES than to the patient — educate and treat with anticholinergics", "In hospice, RR of 10 in a comfortable patient is ACCEPTABLE — do not withhold opioids based on arbitrary cutoffs", "Constipation is the ONLY opioid side effect without tolerance — always prescribe prophylactic bowel regimen"],
    quiz: [{ question: "What is the main difference between palliative care and hospice care?", options: ["They are the same thing", "Palliative care can be at any illness stage alongside curative treatment; hospice is for terminal prognosis with comfort-focused goals", "Hospice provides aggressive curative treatment", "Palliative care is only in hospitals"], correct: 1, rationale: "Palliative care can begin at any point during serious illness concurrently with curative treatments. Hospice is for patients with ≤6 months prognosis who have chosen comfort over cure." }, { question: "A family is distressed by rattling breathing in a hospice patient. Best action?", options: ["Aggressive suctioning every 30 minutes", "Explain the death rattle typically does not distress the patient; reposition and administer anticholinergic as ordered", "Increase IV fluids", "Call 911"], correct: 1, rationale: "Terminal secretions (death rattle) are caused by inability to clear secretions as consciousness declines. More distressing to families than patients. Manage with repositioning, anticholinergics, and family education." }, { question: "A hospice patient on morphine has RR 10 and reports feeling comfortable. What should the nurse do?", options: ["Withhold morphine (RR below 12)", "Continue morphine — patient is comfortable and RR is adequate", "Give naloxone immediately", "Request hospital transfer"], correct: 1, rationale: "In hospice, comfort is the goal. RR of 10 with a comfortable patient is acceptable. Withholding would cause unnecessary suffering." }]
  },

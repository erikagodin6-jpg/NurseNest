...
export const orthopedicLessons: Record<string, LessonContent> = {
  ...
  "rhabdomyolysis": {
    ...
    cellular: {
      title: "Skeletal Muscle Breakdown, CK Elevation, and AKI Risk",
      content: "Rhabdomyolysis results from the destruction of skeletal muscle cells (myocytes) with release of intracellular contents into the circulation. When the sarcolemma loses integrity, massive amounts of potassium, phosphorus, myoglobin, creatine kinase (CK), lactate dehydrogenase, and uric acid flood the bloodstream. The primary mechanism involves disruption of intracellular calcium homeostasis - when calcium floods the sarcoplasm uncontrollably, it activates calcium-dependent proteases (calpains) and lipases that digest myofibrils and membrane phospholipids. ATP depletion prevents the sarcoplasmic reticulum and plasma membrane calcium pumps from restoring normal calcium gradients, creating a self-perpetuating cycle of destruction. The released myoglobin overwhelms renal clearance capacity and causes acute kidney injury through tubular obstruction, oxidative damage, and renal vasoconstriction. Hyperkalemia from cellular lysis poses an immediate cardiac arrest risk before renal failure develops."
    },
    riskFactors: [
      "Crush injuries and prolonged immobilization (found down) compressing muscle tissue",
      "Extreme physical exertion especially in untrained individuals or hot/humid environments",
      "Statin medications particularly at high doses or combined with interacting drugs (fibrates, macrolides)",
      "Cocaine and amphetamine use causing vasospasm, hyperthermia, and sustained muscle contraction",
      "Neuroleptic malignant syndrome from dopamine antagonist medications",
      "Electrical injuries and lightning strikes causing direct muscle depolarization and coagulative necrosis",
      "Severe hypokalemia or hypophosphatemia disrupting membrane stability",
      "Status epilepticus with prolonged sustained muscle contraction and metabolic exhaustion"
    ],
    diagnostics: [
      "Serum CK greater than 5 times normal (often 10,000-100,000+ U/L) - the definitive diagnostic marker",
      "Serum potassium elevated above 5.5 mEq/L from massive intracellular release",
      "Serum phosphorus elevated from intracellular release causing reciprocal hypocalcemia",
      "Dark brown urine positive for blood on dipstick with absent RBCs on microscopy",
      "Rising BUN and creatinine indicating developing acute kidney injury",
      "Metabolic acidosis with elevated lactate from tissue ischemia and cellular lysis"
    ],
    management: [
      "Aggressive IV normal saline at 200-300 mL/hr (may require 10-12 L/day) to maintain urine output above 200 mL/hr",
      "Continuous cardiac monitoring with emergent treatment of hyperkalemia (IV calcium gluconate to stabilize myocardium)",
      "Serial CK levels every 6-12 hours to track muscle destruction trend",
      "IV sodium bicarbonate to alkalinize urine if pH below 6.5",
      "Fasciotomy for compartment syndrome causing ongoing ischemic muscle damage",
      "Hemodialysis for refractory hyperkalemia, severe acidosis, or oliguric AKI"
    ],
    nursingActions: [
      "Monitor urine output hourly with goal of 200-300 mL/hr during aggressive fluid resuscitation",
      "Assess urine color every void - transition from dark brown to amber to clear indicates improving clearance",
      "Monitor cardiac rhythm continuously for peaked T waves, widened QRS, and sine wave patterns indicating hyperkalemia",
      "Perform neurovascular checks every 1-2 hours on affected extremities (5 P's: pain, pallor, pulselessness, paresthesia, paralysis)",
      "Administer IV fluids as ordered and monitor for fluid overload (lung sounds, JVD, peripheral edema)",
      "Report CK levels and potassium trends to provider - rising values indicate ongoing muscle destruction",
      "Assess pain and provide appropriate analgesia while avoiding nephrotoxic medications"
    ],
    signs: {
      left: [
        "Severe muscle pain, tenderness, and weakness in affected groups",
        "Dark brown (tea or cola-colored) urine from myoglobinuria",
        "Muscle swelling with taut, tender compartments on palpation",
        "Elevated temperature from inflammatory response and tissue necrosis"
      ],
      right: [
        "Tachycardia and hypotension from third-spacing and volume depletion",
        "Peaked T waves and ECG changes from life-threatening hyperkalemia",
        "Decreased urine output progressing to oliguria or anuria",
        "General malaise, nausea, and confusion from metabolic derangements"
      ]
    },
    medications: [
      {
        ...
        action: "Raises the threshold potential of cardiac myocytes, antagonizing the membrane-depolarizing effects of hyperkalemia and protecting against fatal dysrhythmias",
        sideEffects: "Bradycardia with rapid infusion, tissue necrosis with extravasation, hypercalcemia, digitalis toxicity potentiation",
        contra: "Concurrent digitalis therapy (increases dig toxicity), hypercalcemia, ventricular fibrillation",
        pearl: "Calcium gluconate does NOT lower potassium level - it only buys time by stabilizing the myocardium; additional treatments (insulin/glucose, kayexalate) are needed to actually shift or remove potassium"
      }
    ],
    pearls: [
      "The lethal triad of rhabdomyolysis is hyperkalemia (cardiac arrest risk), myoglobinuria (AKI risk), and disseminated intravascular coagulation - hyperkalemia kills fastest",
      "Fluid resuscitation is the single most important intervention - early aggressive hydration can prevent AKI in up to 95% of cases",
      "CK peaks 24-72 hours after injury onset and should trend downward with effective treatment - a rising CK indicates ongoing muscle destruction requiring investigation of the cause"
    ],
    quiz: [
      {
        question: "A patient admitted with rhabdomyolysis has a potassium level of 6.8 mEq/L. Which intervention should the nurse anticipate first?",
        options: [
          "Administer oral kayexalate to bind potassium in the GI tract",
          "Administer IV calcium gluconate to stabilize the cardiac membrane",
          "Initiate emergent hemodialysis for potassium removal",
          "Administer IV sodium bicarbonate to alkalinize the urine"
        ],
        correct: 1,
        rationale: "With potassium of 6.8 mEq/L, the immediate priority is cardiac membrane stabilization with IV calcium gluconate to prevent fatal dysrhythmias. While kayexalate, insulin/glucose, and dialysis will lower potassium, calcium gluconate acts within minutes to protect the heart and is always the first intervention for severe hyperkalemia."
      }
    ]
  },

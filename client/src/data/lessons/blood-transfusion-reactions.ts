...
import imgTACO from "@assets/taco_1773268456011.png";

export const bloodTransfusionReactionLessons: Record<string, LessonContent> = {
  "blood-transfusion-reactions": {
    title: "Blood Transfusion Reactions: Complete Clinical Guide",
    image: imgTACO,
    cellular: {
      title: "Immunology of Transfusion Reactions and ABO/Rh Compatibility",

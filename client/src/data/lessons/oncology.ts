...
export const oncologyLessons: Record<string, LessonContent> = {
  ...
  "basal-cell-carcinoma": {
    ...
    cellular: {
      title: "Pathophysiology of Basal Cell Carcinoma",
      content: "Basal cell carcinoma (BCC) is the most common skin malignancy, arising from the basal layer of the epidermis. Chronic ultraviolet (UV) radiation exposure causes cumulative DNA damage in basal keratinocytes, particularly mutations in the Hedgehog signaling pathway and the PTCH1 tumor suppressor gene. BCC is characterized by slow, locally invasive growth with extremely low metastatic potential (less than 0.1%). The tumor typically presents as a pearly, translucent papule or nodule with rolled borders and visible telangiectasias on sun-exposed areas, most commonly the face. The nodular subtype is most common, while the morpheaform (sclerosing) variant has ill-defined borders and is the most difficult to treat. Despite its low metastatic rate, untreated BCC can cause significant local tissue destruction, invading cartilage, bone, and vital structures."
    },
    riskFactors: [
      "Chronic cumulative UV radiation exposure (occupational or recreational)",
      "Fair skin, light eyes, and red or blonde hair (Fitzpatrick skin types I-II)",
      ...
      "Basal cell nevus syndrome (Gorlin syndrome - autosomal dominant)",
      "Arsenic exposure",
      "Male sex and age over 50 years"
    ],
    diagnostics: [
      "Dermatoscopy showing arborizing (tree-like) telangiectasias and blue-gray ovoid nests",
      "Shave or punch biopsy for histologic confirmation",
      "Full skin examination to identify additional lesions",
      "Photography for baseline documentation and serial monitoring"
    ],
    management: [
      "Mohs micrographic surgery for high-risk or cosmetically sensitive areas (face, ears)",
      "Surgical excision with margin assessment for low-risk lesions",
      "Electrodesiccation and curettage for superficial, low-risk BCC",
      "Topical imiquimod or 5-fluorouracil for superficial BCC in selected cases",
      "Vismodegib (Hedgehog pathway inhibitor) for locally advanced or metastatic BCC"
    ],
    nursingActions: [
      "Educate about UV protection: broad-spectrum SPF 30+ sunscreen, protective clothing, shade-seeking behavior",
      "Teach skin self-examination using the ABCDE criteria and full-body technique",
      "Provide wound care instructions following surgical excision or Mohs surgery",
      "Schedule regular follow-up skin examinations (every 6-12 months post-treatment)",
      "Assess for new or recurrent lesions at each visit",
      "Counsel on smoking cessation and avoidance of tanning beds"
    ],
    signs: {
      left: [
        "Pearly, translucent papule or nodule with rolled borders",
        "Visible telangiectasias on the surface of the lesion",
        "Central ulceration or crusting (rodent ulcer appearance)",
        "Non-healing wound that bleeds intermittently and fails to heal"
      ],
      right: [
        "Most common on sun-exposed areas (face, nose, ears, neck)",
        "Slowly enlarging lesion present for months to years",
        "Waxy, scar-like plaque in morpheaform subtype",
        "Pigmented variant may mimic melanoma in darker skin tones"
      ]
    },
    medications: [
      {
        name: "Vismodegib (Erivedge)",
        type: "Hedgehog pathway inhibitor",
        action: "Inhibits Smoothened (SMO) receptor in the Hedgehog signaling pathway, blocking the aberrant signaling that drives basal cell proliferation",
        sideEffects: "Muscle spasms, alopecia, dysgeusia (taste disturbance), weight loss, fatigue, amenorrhea",
        contra: "Pregnancy (highly teratogenic - Category X), lactation",
        pearl: "Strict pregnancy prevention is mandatory - female patients must use effective contraception during treatment and for 24 months after discontinuation due to severe teratogenicity"
      }
    ],
    pearls: [
      "BCC is the most common cancer in humans but has the lowest metastatic potential - local tissue destruction is the primary concern if left untreated",
      "The classic presentation is a pearly papule with telangiectasias on the face that bleeds easily and fails to heal - patients often present saying they have a pimple that will not go away",
      "Patients with one BCC have a 50% chance of developing another within 5 years - lifelong surveillance and sun protection are essential"
    ],
    quiz: [
      {
        question: "A patient presents with a slowly growing, pearly nodule with visible small blood vessels on the nose that has been present for 8 months and bleeds intermittently. Which type of skin cancer is most likely?",
        options: [
        ...
        correct: 1,
        rationale: "The classic presentation of basal cell carcinoma is a pearly, translucent papule or nodule with visible telangiectasias on sun-exposed skin (especially the face and nose) that grows slowly and bleeds intermittently without healing. This is the most common skin cancer and has the lowest metastatic potential."
      }
    ]
  },
  ...
  "squamous-cell-carcinoma": {
    ...
    cellular: {
      ...
      content: "Cutaneous squamous cell carcinoma (SCC) arises from malignant transformation of keratinocytes in the spinous layer of the epidermis. Chronic UV radiation induces cumulative DNA damage, particularly mutations in the TP53 tumor suppressor gene, leading to uncontrolled keratinocyte proliferation. SCC frequently develops from precursor lesions called actinic keratoses (AKs), which represent carcinoma in situ confined to the epidermis. Unlike basal cell carcinoma, SCC carries a meaningful metastatic risk (2-6% overall, higher in immunosuppressed patients), typically spreading via lymphatic channels to regional lymph nodes. High-risk features include tumor diameter greater than 2 cm, depth beyond the subcutis, perineural invasion, poor differentiation, and location on the ear, lip, or temple. Immunosuppressed patients, particularly organ transplant recipients, develop SCC at 65-250 times the rate of the general population."
    },
    riskFactors: [
      "Chronic cumulative UV radiation exposure",
      "Immunosuppression (organ transplant recipients at highest risk)",
      "Pre-existing actinic keratoses (precursor lesions)",
      "Fair skin and history of sunburns",
      "Chronic wounds, scars, or areas of chronic inflammation (Marjolin ulcer)",
      "Tobacco use (especially for lip and oral SCC)",
      "Exposure to arsenic or industrial carcinogens",
      "Human papillomavirus infection (genital and periungual SCC)"
    ],
    diagnostics: [
      "Punch or excisional biopsy for histologic confirmation and depth assessment",
      "Dermoscopy showing white structureless areas and keratin scales",
      "Lymph node palpation and possible sentinel lymph node biopsy for high-risk lesions",
      "CT or MRI for suspected perineural invasion or deep tissue involvement",
      "Full skin examination for additional SCC or actinic keratoses"
    ],
    management: [
      "Wide local excision with appropriate surgical margins (4-6 mm minimum)",
      "Mohs micrographic surgery for high-risk locations or recurrent SCC",
      "Radiation therapy for inoperable tumors or adjuvant treatment",
      "Lymph node dissection for confirmed nodal metastasis",
      "Cemiplimab (PD-1 inhibitor) for locally advanced or metastatic SCC",
      "Treatment of actinic keratoses to prevent progression (cryotherapy, topical 5-FU)"
    ],
    nursingActions: [
      "Educate about UV protection and regular skin self-examination",
      "Monitor surgical wound for signs of infection and proper healing",
      "Assess regional lymph nodes during follow-up visits for new enlargement",
      "Counsel immunosuppressed patients about increased skin cancer risk and need for frequent dermatologic surveillance",
      "Reinforce importance of treating actinic keratoses as precancerous lesions",
      "Provide referral for smoking cessation programs"
    ],
    signs: {
      left: [
        "Firm, erythematous, keratotic papule or plaque with a rough, scaly surface",
        "Indurated (hardened) base suggesting deeper invasion",
        "Ulceration with raised, everted borders",
        "Rapid growth over weeks to months (faster than BCC)"
      ],
      right: [
        "Most common on chronically sun-exposed areas (face, ears, dorsal hands, lower lip)",
        "Cutaneous horn (keratinized projection) overlying the lesion",
        "Tenderness or pain indicating perineural invasion",
        "Regional lymphadenopathy suggesting metastatic spread"
      ]
    },
    medications: [
      {
        name: "Fluorouracil 5% cream (Efudex)",
        type: "Topical antimetabolite",
        action: "Inhibits thymidylate synthase, blocking DNA synthesis in rapidly dividing cells - used topically for actinic keratoses and superficial SCC in situ",
        sideEffects: "Intense local inflammatory reaction (erythema, erosion, crusting, pain), photosensitivity, skin irritation",
        contra: "Dihydropyrimidine dehydrogenase (DPD) deficiency (risk of systemic toxicity), pregnancy, open wounds",
        pearl: "The expected inflammatory response is a sign of treatment efficacy - educate patients that redness, erosion, and discomfort are normal and treatment should continue for the full prescribed duration (typically 2-6 weeks)"
      }
    ],
    pearls: [
      "SCC has a higher metastatic potential than BCC - regional lymph node assessment is part of the clinical evaluation, especially for high-risk lesions",
      "Actinic keratoses are the precursors to SCC - treating them with cryotherapy or topical 5-fluorouracil is cancer prevention",
      "Organ transplant recipients on chronic immunosuppression develop SCC at 65-250 times the general population rate - they require skin examinations every 3-6 months"
    ],
    quiz: [
      {
        question: "A nurse is educating an organ transplant recipient about skin cancer risk. Which statement by the patient indicates understanding of the teaching?",
        options: [
          "I only need a skin check if I notice a new mole",
          "My immunosuppressive medications put me at much higher risk for squamous cell carcinoma, so I need regular skin exams",
          "Squamous cell carcinoma never spreads to other parts of the body",
          "I can stop sun protection once my actinic keratoses are treated"
        ],
        correct: 1,
        rationale: "Organ transplant recipients on immunosuppressive therapy have a dramatically increased risk of SCC (65-250 times the general population). They require regular dermatologic surveillance every 3-6 months, strict UV protection, and prompt treatment of actinic keratoses."
      }
    ]
  },

...
const npExtraBank: Record<string, LessonContent> = {
  ...
  "np-testbank-differential-diagnosis": {
    ...
    quiz: [
      ...
      { question: "A 30-year-old female presents with fatigue, joint pain, malar rash, and a positive ANA. Anti-dsDNA is elevated. What should the NP order to complete the workup?", options: ["Rheumatoid factor only", "Complement levels (C3, C4), CBC, urinalysis, and anti-Smith antibodies", "HLA-B27 testing", "ESR alone"], correct: 1, rationale: "SLE workup includes complement levels (low in active disease), CBC (cytopenias), urinalysis (proteinuria/casts for lupus nephritis), anti-Smith (highly specific for SLE), and anti-dsDNA (correlates with disease activity and nephritis)." },
  ...
  "np-testbank-emergency-management": {
    ...
    quiz: [
      ...
      { question: "A client with suspected pulmonary embolism has a Wells score of 8 and is hemodynamically unstable. What should the NP order?", options: ["D-dimer testing", "CT pulmonary angiography", "Systemic thrombolysis with alteplase", "Observation with heparin only"], correct: 2, rationale: "Massive PE (hemodynamically unstable) is a medical emergency. Systemic thrombolysis (alteplase 100mg IV over 2 hours) is indicated for massive PE with hemodynamic instability (hypotension, shock) when benefits outweigh bleeding risk." },

...
export const generatedBatch047Lessons: Record<string, LessonContent> = {
  ...
  "htn-mechanisms-np": {
    ...
    cellular: { title: "Pathophysiology of Htn Mechanisms", content: "the clinician applies advanced clinical reasoning to the assessment and management of Htn Mechanisms, integrating comprehensive pathophysiological knowledge with evidence-based diagnostic and therapeutic decision-making at the independent practitioner level. Assessment includes focused history using structured frameworks (OLDCARTS for symptom analysis, comprehensive review of systems), targeted physical examination with provocative maneuvers as indicated, and interpretation of relevant diagnostic studies (laboratory investigations, imaging, and specialized testing). The clinician formulates a differential diagnosis using systematic clinical reasoning, applies validated clinical prediction rules and scoring systems to guide investigation and management, and selects evidence-based pharmacotherapy based on mechanism of action, pharmacokinetic/pharmacodynamic principles, patient-specific factors (age, renal and hepatic function, comorbidities, drug interactions, pregnancy status, allergies), and current clinical practice guidelines. Management integrates pharmacological and non-pharmacological interventions, patient education with health literacy assessment, shared decision-making, and appropriate follow-up monitoring. The clinician identifies red flags requiring urgent investigation or intervention, determines criteria for specialist referral or emergency department transfer, coordinates interprofessional collaborative care, and implements quality improvement strategies to optimize patient outcomes." },
  ...
  "huntington-disease-genetic-np": {
    ...
    cellular: { title: "Pathophysiology of Huntington Disease", content: "the clinician applies advanced clinical reasoning to the assessment and management of Huntington Disease, integrating comprehensive pathophysiological knowledge with evidence-based diagnostic and therapeutic decision-making at the independent practitioner level. Assessment includes focused history using structured frameworks (OLDCARTS for symptom analysis, comprehensive review of systems), targeted physical examination with provocative maneuvers as indicated, and interpretation of relevant diagnostic studies (laboratory investigations, imaging, and specialized testing). The clinician formulates a differential diagnosis using systematic clinical reasoning, applies validated clinical prediction rules and scoring systems to guide investigation and management, and selects evidence-based pharmacotherapy based on mechanism of action, pharmacokinetic/pharmacodynamic principles, patient-specific factors (age, renal and hepatic function, comorbidities, drug interactions, pregnancy status, allergies), and current clinical practice guidelines. Management integrates pharmacological and non-pharmacological interventions, patient education with health literacy assessment, shared decision-making, and appropriate follow-up monitoring. The clinician identifies red flags requiring urgent investigation or intervention, determines criteria for specialist referral or emergency department transfer, coordinates interprofessional collaborative care, and implements quality improvement strategies to optimize patient outcomes." },
  ...
  "huntington-disease-np": {
    ...
    cellular: { title: "Huntington Disease: Genetic Counseling", content: "the clinician applies advanced clinical reasoning to the assessment and management of Huntington Disease: Genetic Counseling & Management, integrating comprehensive pathophysiological knowledge with evidence-based diagnostic and therapeutic decision-making at the independent practitioner level. Assessment includes focused history using structured frameworks (OLDCARTS for symptom analysis, comprehensive review of systems), targeted physical examination with provocative maneuvers as indicated, and interpretation of relevant diagnostic studies (laboratory investigations, imaging, and specialized testing). The clinician formulates a differential diagnosis using systematic clinical reasoning, applies validated clinical prediction rules and scoring systems to guide investigation and management, and selects evidence-based pharmacotherapy based on mechanism of action, pharmacokinetic/pharmacodynamic principles, patient-specific factors (age, renal and hepatic function, comorbidities, drug interactions, pregnancy status, allergies), and current clinical practice guidelines. Management integrates pharmacological and non-pharmacological interventions, patient education with health literacy assessment, shared decision-making, and appropriate follow-up monitoring. The clinician identifies red flags requiring urgent investigation or intervention, determines criteria for specialist referral or emergency department transfer, coordinates interprofessional collaborative care, and implements quality improvement strategies to optimize patient outcomes." },
  ...
  "hydrocephalus": {
    title: "Hydrocephalus",
    image: imgVPShunt,
    cellular: { title: "Pathophysiology of Hydrocephalus", content: "Hydrocephalus results from an imbalance between cerebrospinal fluid (CSF) production and absorption, leading to ventricular dilation and increased intracranial pressure. CSF is produced primarily by the choroid plexus at a rate of approximately 500 mL/day (total volume approximately 150 mL), circulates through the ventricular system and subarachnoid space, and is absorbed by arachnoid granulations into the superior sagittal sinus. Communicating hydrocephalus occurs when CSF absorption is impaired (post-meningitis, post-subarachnoid hemorrhage), while non-communicating (obstructive) hydrocephalus results from blockage of CSF flow within the ventricular system (tumors, congenital aqueductal stenosis). In infants, signs include increasing head circumference, bulging fontanelle, sunset eyes (downward gaze deviation), and irritability; in older children and adults, signs include headache, vomiting, papilledema, and altered mental status — treatment involves CSF diversion through ventriculoperitoneal (VP) shunt placement or endoscopic third ventriculostomy." },
  ...
  "hypercalcemia-workup-np": {
    ...
    cellular: { title: "Hypercalcemia Workup: PTH-Mediated vs Non-PTH", content: "the clinician applies advanced clinical reasoning to the assessment and management of Hypercalcemia Workup: PTH-Mediated vs Non-PTH Differential, integrating comprehensive pathophysiological knowledge with evidence-based diagnostic and therapeutic decision-making at the independent practitioner level. Assessment includes focused history using structured frameworks (OLDCARTS for symptom analysis, comprehensive review of systems), targeted physical examination with provocative maneuvers as indicated, and interpretation of relevant diagnostic studies (laboratory investigations, imaging, and specialized testing). The clinician formulates a differential diagnosis using systematic clinical reasoning, applies validated clinical prediction rules and scoring systems to guide investigation and management, and selects evidence-based pharmacotherapy based on mechanism of action, pharmacokinetic/pharmacodynamic principles, patient-specific factors (age, renal and hepatic function, comorbidities, drug interactions, pregnancy status, allergies), and current clinical practice guidelines. Management integrates pharmacological and non-pharmacological interventions, patient education with health literacy assessment, shared decision-making, and appropriate follow-up monitoring. The clinician identifies red flags requiring urgent investigation or intervention, determines criteria for specialist referral or emergency department transfer, coordinates interprofessional collaborative care, and implements quality improvement strategies to optimize patient outcomes." },
  ...
  "hyperemesis-gravidarum": {
    ...
    cellular: { title: "Pathophysiology of Hyperemesis Gravidarum", content: "Hyperemesis gravidarum (HG) represents the severe end of the nausea and vomiting in pregnancy spectrum, characterized by persistent vomiting, weight loss greater than 5% of pre-pregnancy weight, dehydration, electrolyte imbalances, and ketonuria. The pathophysiology involves elevated human chorionic gonadotropin (hCG) levels stimulating the chemoreceptor trigger zone in the medulla, with higher hCG levels (as seen in molar pregnancies and multiple gestations) correlating with increased severity. Hormonal contributions include estrogen-mediated gastric smooth muscle relaxation and progesterone-induced decreased lower esophageal sphincter tone, compounded by altered thyroid function (transient hyperthyroidism from hCG's TSH-like activity). Management includes IV fluid resuscitation with dextrose-containing solutions, electrolyte correction (particularly potassium and magnesium), thiamine supplementation (to prevent Wernicke encephalopathy before dextrose administration), and antiemetic therapy progressing from pyridoxine-doxylamine to ondansetron, metoclopramide, or corticosteroids for refractory cases." },

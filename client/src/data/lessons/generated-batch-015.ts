...
export const generatedBatch015Lessons: Record<string, LessonContent> = {
  "calcium-imbalance-rpn": {
    title: "Calcium Imbalances (Hypo/Hypercalcemia)",
    cellular: { title: "Pathophysiology of Calcium Imbalances (Hypo/Hypercalcemia)", content: "[WRITE YOUR PATHOPHYSIOLOGY AND INTRODUCTION HERE]" },
    riskFactors: ["Advanced age or extremes of age","Family history of calcium imbalance or related conditions","Chronic comorbidities (hypertension, diabetes, obesity)","Sedentary lifestyle and poor nutritional status","Tobacco, alcohol, or substance use","Immunocompromised state or prolonged medication use"],
    ...
    quiz: [
      {
        question: "A nurse is caring for a patient with calcium imbalance. Which assessment finding requires immediate intervention?",
      ...
      {
        question: "Which nursing action is most appropriate when managing a patient with calcium imbalance?",
      ...
      {
        question: "The patient asks about their calcium imbalance diagnosis. What is the best initial nursing response?",

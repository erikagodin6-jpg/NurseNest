...
export const cbiLessons: Record<string, LessonContent> = {
  "continuous-bladder-irrigation-rpn": {
    ...
    management: [
      ...
      "Report bright red drainage, large clots, or catheter obstruction to the RN immediately",

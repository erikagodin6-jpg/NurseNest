...
export const clinicalConditionsBatchPLessons: Record<string, LessonContent> = {
  "hpa-axis-stress-rpn": {
    ...
    quiz: [
      { question: "Which assessment finding should the RPN report immediately in a patient abruptly taken off long-term prednisone?", options: ["Blood pressure of 142/88 mmHg", "Severe hypotension with confusion and weakness", "Mild ankle edema", "Fasting glucose of 110 mg/dL"], correct: 1, rationale: "Abrupt withdrawal of chronic corticosteroids can cause adrenal crisis due to suppressed HPA axis. Severe hypotension with confusion indicates adrenal crisis requiring emergent treatment." },
      { question: "The RPN notes a patient on chronic prednisone has developed a round face, central weight gain, and elevated blood glucose. What does this suggest?", options: ["Addison disease", "Cushing syndrome features from exogenous steroids", "Hypothyroidism", "Metabolic alkalosis"], correct: 1, rationale: "Moon face, central obesity, and hyperglycemia are classic features of Cushing syndrome caused by chronic exogenous glucocorticoid use." },
      { question: "What is the priority nursing action when a patient on hydrocortisone replacement develops a fever of 39°C?", options: ["Hold the hydrocortisone to prevent immunosuppression", "Report to the RN for possible stress dose adjustment", "Administer acetaminophen only", "Decrease the hydrocortisone dose"], correct: 1, rationale: "During physiologic stress such as fever or illness, patients on cortisol replacement require stress dosing (increased dose). The RPN should report to the RN for adjustment." }
    ]
  },

  "hpa-axis-stress-rn": {
    title: "HPA Axis & Cortisol Stress Response: RN Clinical Management",
    cellular: {
      title: "Neuroendocrine Stress Pathways",
      content: "The hypothalamic-pituitary-adrenal (HPA) axis is the central neuroendocrine pathway governing the stress response. Hypothalamic paraventricular nucleus neurons release corticotropin-releasing hormone (CRH) and arginine vasopressin (AVP) into the hypophyseal portal system, stimulating anterior pituitary corticotrophs to secrete ACTH. ACTH stimulates the adrenal cortex zona fasciculata to synthesize cortisol from cholesterol. Cortisol binds intracellular glucocorticoid receptors, translocating to the nucleus to modulate gene transcription affecting gluconeogenesis, protein catabolism, anti-inflammatory pathways, and immune suppression. Negative feedback at hypothalamic and pituitary levels normally terminates the response. The sympathetic-adrenomedullary (SAM) axis provides rapid stress response through catecholamine release (epinephrine and norepinephrine) from the adrenal medulla, increasing heart rate, blood pressure, and metabolic activity. Chronic HPA activation leads to allostatic overload with metabolic syndrome, immune dysfunction, cardiovascular disease, and neuropsychiatric disorders. The RN performs comprehensive assessment, manages cortisol-related complications, coordinates care across disciplines, and educates patients on stress management and medication adherence."
    },
    riskFactors: [
      ...
      "Long-term exogenous corticosteroid use",
      "Obesity with insulin resistance",
      "Sleep disorders and circadian disruption",
      "Autoimmune adrenal insufficiency (Addison disease)"
    ],
    diagnostics: [
      "Interpret morning serum cortisol levels (normal 5-25 mcg/dL; low suggests adrenal insufficiency)",
      "Evaluate 24-hour urinary free cortisol for suspected Cushing syndrome",
      "Assess ACTH levels to differentiate primary from secondary adrenal disorders",
      "Monitor serum electrolytes: hyponatremia and hyperkalemia suggest cortisol/aldosterone deficiency",
      "Evaluate blood glucose trends for stress-induced hyperglycemia",
      "Monitor blood pressure patterns for cortisol-related hypertension",
      "Assess dexamethasone suppression test results for Cushing syndrome workup"
    ],
    management: [
      "Implement steroid tapering protocols to prevent adrenal crisis",
      "Administer stress-dose steroids during acute illness, surgery, or physiologic stress",
      "Monitor and manage stress-induced hyperglycemia with insulin sliding scale as ordered",
      "Coordinate endocrinology referral for suspected Cushing syndrome or Addison disease",
      "Implement fall precautions for patients on chronic steroids (osteoporosis risk)",
      "Manage fluid and electrolyte imbalances associated with cortisol excess or deficiency",
      "Educate patient on medical alert identification for adrenal insufficiency",
      "Coordinate multidisciplinary care: endocrinology, psychiatry, nutrition, social work"
    ],
    nursingActions: [
      "Perform comprehensive assessment including vital signs, glucose, weight trends, and mental status",
      "Assess for Cushing features: moon face, buffalo hump, striae, thin skin, easy bruising",
      "Assess for Addisonian crisis: hypotension, tachycardia, weakness, abdominal pain, hyperpigmentation",
      "Monitor steroid adherence and educate on importance of gradual tapering",
      "Implement infection prevention strategies for immunosuppressed patients on steroids",
      "Assess psychosocial stressors using validated tools and coordinate mental health support",
      "Evaluate sleep quality and circadian patterns as part of stress assessment",
      "Educate on stress management techniques: exercise, sleep hygiene, mindfulness, social support"
    ],
    signs: {
      left: [
        "Cortisol excess (Cushing): hypertension, hyperglycemia, central obesity",
      ...
      right: [
        "Cortisol deficiency (Addison): hypotension, orthostatic changes",
        "Hypoglycemia and fatigue",
        "Hyponatremia and hyperkalemia",
        "Hyperpigmentation (primary only, due to elevated ACTH/MSH)",
        "Nausea, vomiting, weight loss",
        "Salt craving",
        "Adrenal crisis: cardiovascular collapse, altered LOC"
      ]
    },
    medications: [
      { name: "Hydrocortisone", type: "Glucocorticoid replacement", action: "Physiologic cortisol replacement binding glucocorticoid receptors to maintain metabolic, immune, and cardiovascular homeostasis", sideEffects: "Hyperglycemia, fluid retention, immunosuppression, adrenal suppression, osteoporosis", contra: "Systemic fungal infections, active untreated TB", pearl: "Stress dosing: double or triple the dose during illness/surgery. Standard replacement is 15-25 mg/day in divided doses mimicking circadian rhythm (2/3 AM, 1/3 PM)." },
      { name: "Dexamethasone", type: "Long-acting glucocorticoid", action: "Potent synthetic glucocorticoid with 25-30x potency of cortisol; minimal mineralocorticoid activity", sideEffects: "Severe adrenal suppression, hyperglycemia, psychosis, avascular necrosis", contra: "Systemic fungal infections, concurrent live vaccines", pearl: "Used diagnostically in dexamethasone suppression test. Low-dose (1mg overnight) screens for Cushing; high-dose (8mg) differentiates pituitary from ectopic ACTH." },
      { name: "Fludrocortisone", type: "Mineralocorticoid replacement", action: "Synthetic aldosterone analog promoting sodium reabsorption and potassium excretion in the collecting duct", sideEffects: "Hypertension, hypokalemia, edema, heart failure exacerbation", contra: "Severe hypertension, decompensated heart failure", pearl: "Essential in primary adrenal insufficiency where both cortisol and aldosterone are deficient. Not needed in secondary adrenal insufficiency (aldosterone is RAAS-regulated)." },
      { name: "Ketoconazole", type: "Cortisol synthesis inhibitor", action: "Inhibits multiple cytochrome P450 enzymes in cortisol synthesis including 11-beta-hydroxylase and 17-alpha-hydroxylase", sideEffects: "Hepatotoxicity, GI upset, adrenal insufficiency, gynecomastia", contra: "Hepatic disease, concurrent hepatotoxic drugs", pearl: "Used as medical therapy in Cushing syndrome to reduce cortisol while awaiting definitive surgical treatment. Monitor liver function tests frequently." }
    ],
    pearls: [
      "Differentiate primary (high ACTH, low cortisol, hyperpigmentation) from secondary (low ACTH, low cortisol, no hyperpigmentation) adrenal insufficiency",
      "Adrenal crisis is a medical emergency: treat with IV hydrocortisone 100mg bolus, IV fluids, and dextrose before lab confirmation",
      "Chronic cortisol excess causes immunosuppression: monitor for opportunistic infections and delayed wound healing",
      "Stress hyperglycemia differs from diabetes: cortisol drives gluconeogenesis and insulin resistance during acute illness",
      "PTSD shows paradoxical HPA pattern: low basal cortisol with enhanced glucocorticoid receptor sensitivity"
    ],
    quiz: [
      { question: "A patient with known Addison disease presents with fever, severe hypotension, and altered consciousness. What is the priority intervention?", options: ["Obtain cortisol level and wait for results", "Administer IV hydrocortisone 100mg bolus immediately", "Start oral prednisone 5mg", "Administer IV normal saline only"], correct: 1, rationale: "Adrenal crisis is life-threatening and requires immediate IV hydrocortisone (100mg bolus) along with aggressive IV fluid resuscitation. Treatment should not be delayed for lab confirmation." },
      { question: "Which lab finding helps distinguish primary from secondary adrenal insufficiency?", options: ["Serum glucose level", "Serum ACTH level", "Complete blood count", "Serum albumin"], correct: 1, rationale: "In primary adrenal insufficiency, ACTH is elevated (loss of negative feedback from low cortisol). In secondary, ACTH is low or inappropriately normal due to pituitary or hypothalamic dysfunction." },
      { question: "The RN is educating a patient on chronic hydrocortisone replacement. Which instruction is most important?", options: ["Take the medication only when feeling stressed", "Never abruptly stop the medication and double the dose during illness", "Take the largest dose at bedtime for better sleep", "Avoid all dietary sodium"], correct: 1, rationale: "Patients on chronic cortisol replacement must never stop abruptly (risk of adrenal crisis) and should stress-dose during illness. The largest dose should be taken in the morning to mimic circadian cortisol rhythm." }
    ]
  },

  "hpa-axis-stress-np": {
    title: "HPA Axis & Cortisol Stress Response: NP Prescriptive Management",
    cellular: {
      title: "Advanced HPA Axis Pathophysiology",
      content: "The HPA axis operates through a neuroendocrine cascade: hypothalamic paraventricular nucleus (PVN) neurons secrete CRH and AVP into the hypophyseal portal circulation, stimulating anterior pituitary corticotrophs via CRH-R1 and V1b receptors respectively. ACTH, cleaved from pro-opiomelanocortin (POMC), drives adrenocortical steroidogenesis through the cholesterol side-chain cleavage enzyme and subsequent zona fasciculata enzymes (17-alpha-hydroxylase, 11-beta-hydroxylase) to produce cortisol. Cortisol acts through genomic mechanisms (glucocorticoid receptor-mediated transcription) and non-genomic pathways (rapid membrane effects). Negative feedback occurs at both hypothalamic (suppressing CRH/AVP) and pituitary (suppressing POMC/ACTH) levels. The SAM axis provides rapid catecholaminergic responses through preganglionic sympathetic fibers activating adrenal medullary chromaffin cells. Chronic HPA dysregulation manifests as either hypercortisolism (Cushing syndrome) or hypocortisolism (adrenal insufficiency), each with distinct diagnostic algorithms and management strategies. Modern stress science recognizes allostatic load as the cumulative physiologic toll of chronic stress, contributing to cardiometabolic disease, immune dysfunction, neurodegeneration, and accelerated cellular aging. The NP must order and interpret dynamic endocrine testing, prescribe replacement or suppressive therapy, manage complications, and integrate stress reduction into comprehensive treatment plans."
    },
    riskFactors: [
  ...
  "male-infertility-rpn": {
    ...
    quiz: [
      { question: "A male patient asks the RPN if taking testosterone supplements will help him conceive. What is the best response?", options: ["Yes, higher testosterone improves sperm production", "No, exogenous testosterone actually suppresses sperm production", "It depends on the dose being used", "Testosterone supplements have no effect on fertility"], correct: 1, rationale: "Exogenous testosterone suppresses the HPG axis, reducing GnRH, LH, and FSH, which decreases intratesticular testosterone and impairs spermatogenesis. It is contraindicated in men trying to conceive." },
  ...
  "hearing-loss-differential-rpn": {
    ...
    management: [
      ...
      "Assist with cerumen removal as directed by the RN or provider",
    ...
    quiz: [
      { question: "A patient on IV gentamicin reports new bilateral tinnitus and difficulty hearing. What should the RPN do?", options: ["Document and reassess at the next shift", "Report immediately to the RN as this may indicate ototoxicity", "Irrigate both ears with warm water", "Administer an additional dose of gentamicin"], correct: 1, rationale: "Tinnitus and hearing loss in a patient on aminoglycosides suggest ototoxicity, which can be irreversible. The RPN must report immediately for possible medication hold and audiometric evaluation." },

...
export const obMedicationsLessons: Record<string, LessonContent> = {
  "betamethasone-dexamethasone": {
    title: "Antenatal Corticosteroids (Betamethasone & Dexamethasone)",
    cellular: {
  ...
  "prostaglandins-ob": {
    ...
    cellular: {
      title: "Prostaglandin-Mediated Cervical Ripening & Uterine Stimulation",
  ...
  "oxytocin-ob": {
    title: "Oxytocin (Pitocin) for Labor Induction & Augmentation",
    cellular: {
  ...
  "pph-medications": {
    ...
    cellular: {
      title: "Pharmacologic Management of Postpartum Hemorrhage",
  ...
  "lung-surfactants": {
    ...
    cellular: {
      title: "Surfactant Replacement Therapy for Respiratory Distress Syndrome",
  ...
  "hep-b-vaccine-newborn": {
    ...
    cellular: {
      title: "Neonatal Hepatitis B Immunization & Perinatal Transmission Prevention",
  ...
  "contraceptives": {
    ...
    cellular: {
      title: "Mechanisms of Action & Clinical Considerations for Contraception",

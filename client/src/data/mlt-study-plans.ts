    ...
    weeks: [
      {
        ...
        days: [
          { day: 1, label: "Mon", tasks: [{ type: "lesson", description: "Review Hematology Fundamentals lesson — RBC indices, morphology, WBC differential", duration: "2h", link: "/mlt/lessons/hematology-fundamentals-mlt" }, { type: "flashcards", description: "Study Hematology Morphology flashcard deck (25 cards)", duration: "30min", link: "/careers/mlt/flashcards" }] },

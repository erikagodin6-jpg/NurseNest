...
export const CAREER_CONFIGS: Record<CareerType, CareerConfig> = {
  ...
  psychotherapist: {
    ...
    examNames: ["CRPO Registration Exam", "RP Qualifying Exam"],
    color: "#5C6BC0",
    colorAccent: "#E8EAF6",
    aiTools: [
  ...
  socialWorker: {
    id: "socialWorker",
    name: "Licensed Clinical Social Worker (US)",
    shortName: "Social Work",
    slug: "social-worker",
    description: "LCSW/ASWB exam preparation covering clinical social work practice, DSM-5 diagnosis, and evidence-based interventions",
    icon: "Users",

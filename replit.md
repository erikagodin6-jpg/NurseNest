...
- **i18n System**: 15 languages supported (en, fr, tl, hi, es, zh, ar, ko, pt, pa, vi, ht, ur, ja, fa). RTL support for Arabic, Urdu, Farsi. English block has ~220 keys; 6 Latin-script languages (fr, es, tl, pt, vi, ht) have 141 keys translated with the rest falling back to English; 8 non-Latin languages (hi, zh, ar, ko, pa, ur, ja, fa) have 141 keys in native scripts. Home page is fully internationalized with ~156 t() calls covering every visible section: hero, pills, stats, "What's New", feature cards, secondary features, differentiators, free learning, study topics grid, new nurses section, why NurseNest, FAQ accordion, email capture, and final CTA. Other pages (lessons, flashcards, pricing, navigation) also use t() calls. New keys fall back to English when not yet translated for a language.

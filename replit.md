...
- **Content Quarantine System**: Auto-quarantine of critical non-auto-fixable content issues during scheduled scans with admin UI for quarantine management (view, repair, restore, delete). Publish gate enforces per-question validation (stem length, correct answer, minimum options).

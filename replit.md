...
- **Digital Product Builder**: Canva-style editor with drag-and-drop, multi-select, undo/redo, brand kit, AI image lab, and various export formats. Includes multi-page AI content pagination and object grouping.

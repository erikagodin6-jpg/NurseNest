...
- **Customizable Learning Dashboard**: User-facing dashboard at `/dashboard` with 8 draggable widget types (welcome, progress, recent_lessons, quick_links, exam_stats, study_streak, flashcard_review, clinical_tools). Users can reorder, show/hide, add/remove widgets and save layout to database. Accessible from user dropdown menu. Database table: `dashboard_widgets`.
